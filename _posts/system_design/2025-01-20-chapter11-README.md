...
![ios-push-notifications](/assets/images/system-design/ios-push-notifications.png)
...
![android-push-notifications](/assets/images/system-design/android-push-notifications.png)

### SMS Message
For SMS, third-party providers like Twilio are available:
![sms-messages](/assets/images/system-design/sms-messages.png)

### Email
Although clients can setup their own mail servers, most clients opt-in to use third-party services, like Mailchimp:
![email-sending](/assets/images/system-design/email-sending.png)

Here's final design after including all notification providers:
![notification-providers-design](/assets/images/system-design/notification-providers-design.png)
...
![contact-info-gathering](/assets/images/system-design/contact-info-gathering.png)

Example database tables for storing contact info:
![contact-info-db](/assets/images/system-design/contact-info-db.png)
...
![high-level-design-improved](/assets/images/system-design/high-level-design-improved.png)
...
![notification-log-db](/assets/images/system-design/notification-log-db.png)
...
![notifications-queue](/assets/images/system-design/notifications-queue.png)
...
![notification-events](/assets/images/system-design/notification-events.png)
