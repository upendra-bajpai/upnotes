...
![business-table](/assets/images/system-design/business-table.png)
...
![high-level-design](/assets/images/system-design/high-level-deisgn.png)
...
![2d-search](/assets/images/system-design/2d-search.png)
...
![2d-query-problem](/assets/images/system-design/2d-query-problem.png)

We can, however, build 2D indexes and there are different approaches to that:
![2d-index-options](/assets/images/system-design/2d-index-options.png)
...
![evenly-divided-grid](/assets/images/system-design/evenly-divided-grid.png)
...
![geohash-example](/assets/images/system-design/geohash-example.png)
...
![geohash-precision](/assets/images/system-design/geohash-precision.png)

Geohashes enable us to quickly locate neighboring regions based on a substring of the geohash:
![geohash-substring](/assets/images/system-design/geohash-substrint.png)
...
![boundary-issue-geohash](/assets/images/system-design/boundary-issue-geohash.png)
...
![geohash-boundary-issue-2](/assets/images/system-design/geohash-boundary-issue-2.png)
...
![geohash-expansion](/assets/images/system-design/geohash-expansion.png)
...
![quadtree-example](/assets/images/system-design/quadtree-example.png)

This is an in-memory solution which can't easily be implemented in a database.

Here's how it might look conceptually:
![quadtree-concept](/assets/images/system-design/quadtree-concept.png)
...
![denver-quadtree](/assets/images/system-design/denver-quadtree.png)
...
![hilbert-curve](/assets/images/system-design/hilbert-curbe.png)

This library is great for geofencing, which supports covering arbitrary areas vs. confining yourself to specific quadrants.
![geofence-example](/assets/images/system-design/geofence-example.png)
...
![company-adoptions](/assets/images/system-design/company-adoptions.png)
...
![geohash-table-example](/assets/images/system-design/geohash-table-example.png)
...
![cross-dc-deployment](/assets/images/system-design/cross-dc-deployment.png)
