...
![cruder-app](/assets/images/system-design/cruder-app.png)
...
![cruder-enhanced](/assets/images/system-design/cruder-enhanced.png)
...
![http-caching-example](/assets/images/system-design/http-caching-example.png)
...
![stale-data-not-modified](/assets/images/system-design/stale-data-not-modified.png)
...
![cdn-example](/assets/images/system-design/cdn-example.png)
...
![partition-example](/assets/images/system-design/partition-example.png)
...
![range-partitioning](/assets/images/system-design/range-partitioning.png)
...
![hash-partitioning](/assets/images/system-design/hash-partitioning.png)
...
![consistent-hashing-rebalancing](/assets/images/system-design/consistent-hashing-rebalancing.png)
...
![as-architecture](/assets/images/system-design/as-architecture.png)
...
![as-partition-layer](/assets/images/system-design/as-partition-layer.png)
...
![as-partition-manager](/assets/images/system-design/as-partition-manager.png)
...
![dns-load-balancing](/assets/images/system-design/dns-load-balancing.png)
...
![network-load-balancer](/assets/images/system-design/network-load-balancer.png)
...
![leader-follower-replication](/assets/images/system-design/leader-follower-replication.png)
...
![dynamodb-table-example-1](/assets/images/system-design/dynamodb-table-example-1.png)
...
![dynamodb-table-example-2](/assets/images/system-design/dynamodb-table-example-2.png)
...
![write-aside](/assets/images/system-design/write-aside.png)

Inline cache (aka Write-through) example:
![write-through-cache](/assets/images/system-design/write-through-cache.png)
...
![write-back-cache](/assets/images/system-design/write-back-cache.png)
...
![local-cache](/assets/images/system-design/local-cache.png)
...
![external-cache](/assets/images/system-design/external-cache.png)
...
![monolithic-app](/assets/images/system-design/monolithic-app.png)
...
![microservices](/assets/images/system-design/microservices.png)
...
![file-store-as-buffer](/assets/images/system-design/file-store-as-buffer.png)
...
![control-plane-data-plane](/assets/images/system-design/control-plane-data-plane.png)
...
![inbound-outbound-adapters](/assets/images/system-design/inbound-outbound-adapters.png)
...
![one-way-messaging](/assets/images/system-design/one-way-messaging.png)
...
![request-response-messaging](/assets/images/system-design/request-response-messaging.png)
...
![broadcast-messaging](/assets/images/system-design/broadcast-messaging.png)
