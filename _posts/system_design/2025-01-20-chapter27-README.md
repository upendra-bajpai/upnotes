...
![high-level-flow](/assets/images/system-design/high-level-flow.png)

## Pay-in flow
Here's the high-level overview of the pay-in flow:
![pay-in-flow-high-level](/assets/images/system-design/payin-flow-high-level.png)
...
![hosted-payment-page](/assets/images/system-design/hosted-payment-page.png)
...
![hosted-payment-page-workflow](/assets/images/system-design/hosted-payment-page-workflow.png)
...
![settlement-report](/assets/images/system-design/settlement-report.png)
...
![single-receiver](/assets/images/system-design/single-receiver.png)

Multiple receivers - multiple receivers subscribe to the same topic, but messages are forwarded to all of them:
![multiple-receiver](/assets/images/system-design/multiple-receiver.png)
...
![failed-payments](/assets/images/system-design/failed-payments.png)
...
![retry-mechanism](/assets/images/system-design/retry-mechanism.png)
...
![idempotency-example](/assets/images/system-design/idempotency-example.png)
