...
![message-queue-components](/assets/images/system-design/message-queue-components.png)
...
![point-to-point-model](/assets/images/system-design/point-to-point-model.png)
...
![publish-subscribe-model](/assets/images/system-design/publish-subscribe-model.png)
...
![partitions](/assets/images/system-design/partitions.png)
...
![consumer-groups](/assets/images/system-design/consumer-groups.png)
...
![high-level-architecture](/assets/images/system-design/high-level-architecture.png)
...
![wal-example](/assets/images/system-design/wal-example.png)
...
![message-structure](/assets/images/system-design/message-structure.png)
...
![routing-layer](/assets/images/system-design/routing-layer.png)
...
![routing-layer-producer](/assets/images/system-design/routing-layer-producer.png)
...
![batch-size-throughput-vs-latency](/assets/images/system-design/batch-size-throughput-vs-latency.png)
...
![consumer-example](/assets/images/system-design/consumer-example.png)
...
![consumer-flow](/assets/images/system-design/consumer-flow.png)
...
![consumer-rebalancing](/assets/images/system-design/consumer-rebalancing.png)
...
![consumer-rebalance-example](/assets/images/system-design/consumer-rebalance-example.png)

Let's explore what happens when a consumer joins a group:
![consumer-join-group-usecase](/assets/images/system-design/consumer-join-group-usecase.png)
...
![consumer-leaves-group-usecase](/assets/images/system-design/consumer-leaves-group-usecase.png)
...
![consumer-no-heartbeat-usecase](/assets/images/system-design/consumer-no-heartbeat-usecase.png)

## State storage
The state storage stores mapping between partitions and consumers, as well as the last consumed offsets for a partition.
![state-storage](/assets/images/system-design/state-storage.png)
...
![zookeeper](/assets/images/system-design/zookeeper.png)
...
![replication-example](/assets/images/system-design/replication-example.png)
...
![in-sync-replicas-example](/assets/images/system-design/in-sync-replicas-example.png)
...
![ack-all](/assets/images/system-design/ack-all.png)
...
![ack-1](/assets/images/system-design/ack-1.png)
...
![ack-0](/assets/images/system-design/ack-0.png)
...
![broker-failure-recovery](/assets/images/system-design/broker-failure-recovery.png)
...
![broker-replica-redistribution](/assets/images/system-design/broker-replica-redistribution.png)
...
![partition-exmaple](/assets/images/system-design/partition-exmaple.png)

Decreasing the number of partitions is more involved:
![partition-decrease](/assets/images/system-design/partition-decrease.png)
...
![at-most-once](/assets/images/system-design/at-most-once.png)
...
![at-least-once](/assets/images/system-design/at-least-once.png)
...
![exactly-once](/assets/images/system-design/exactly-once.png)
...
![message-filtering](/assets/images/system-design/message-filtering.png)
...
![delayed-message-implementation](/assets/images/system-design/delayed-message-implementation.png)
