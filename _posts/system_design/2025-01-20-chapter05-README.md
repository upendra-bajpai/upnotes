...
Server-side:
![server-side-rate-limiter](/assets/images/system-design/server-side-rate-limiter.png)

As a middleware between client and server:
![middleware-rate-limiter](/assets/images/system-design/middleware-rate-limiter.png)

How it works, assuming 2 requests per second are allowed:
![middleware-rate-limiter-example](/assets/images/system-design/middleware-rate-limiter-example.png)
...
![token-bucket-algo](/assets/images/system-design/token-bucket-algo.png)
...
![token-bucket-algo-explained](/assets/images/system-design/token-bucket-algo-explained.png)
...
![leaking-bucket-algo](/assets/images/system-design/leaking-bucket-algo.png)
...
![fixed-window-counter-algo](/assets/images/system-design/fixed-window-counter-algo.png)
...
![traffic-burst-problem](/assets/images/system-design/traffic-burst-problem.png)
...
![sliding-window-log-algo](/assets/images/system-design/sliding-window-log-algo.png)
...
![sliding-window-counter-algo](/assets/images/system-design/sliding-window-counter-algo.png)
...
![lyft-rate-limiting-rules](/assets/images/system-design/lyft-rate-limiting-rules.png)

Another example \w max login attempts in a minute:
![lyft-rate-limiting-auth-rules](/assets/images/system-design/lyft-rate-limiting-auth-rules.png)
...
## Detailed design
![detailed-design](/assets/images/system-design/detailed-design.png)
...
![race-condition](/assets/images/system-design/race-condition.png)
...
![synchronization-issue](/assets/images/system-design/synchronization-issue.png)

To solve this issue, we can use a centralized data store (eg Redis) so that the rate limiter instances are stateless.
![redis-centralized-data-store](/assets/images/system-design/redis-centralized-data-store.png)
