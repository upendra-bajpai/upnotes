...
![cap-theorem](/assets/images/system-design/cap-theorem.png)
...
![example-distributed-system](/assets/images/system-design/example-distributed-system.png)

In the real world, a network partition can occur which hinders communication with eg node 3:
![network-partition-example](/assets/images/system-design/network-partition-example.png)
...
![consistent-hashing](/assets/images/system-design/consistent-hashing.png)
...
![data-replication](/assets/images/system-design/data-replication.png)
...
![write-quorum-example](/assets/images/system-design/write-quorum-example.png)
...
![inconsistency-example](/assets/images/system-design/inconsistency-example.png)
...
![inconsistency-resolution](/assets/images/system-design/inconsistency-resolution.png)
...
![multicasting](/assets/images/system-design/multicasting.png)
...
![gossip-protocol](/assets/images/system-design/gossip-protocol.png)
...
![merkle-tree](/assets/images/system-design/merkle-tree.png)
...
![architecture-diagram](/assets/images/system-design/architecture-diagram.png)
...
![node-responsibilities](/assets/images/system-design/node-responsibilities.png)

## Write path
![write-path](/assets/images/system-design/write-pth.png)
...
![read-path-in-memory](/assets/images/system-design/read-path-in-memory.png)

Read path when data is not in memory:
![read-path-not-in-memory](/assets/images/system-design/read-path-not-in-memory.png)
