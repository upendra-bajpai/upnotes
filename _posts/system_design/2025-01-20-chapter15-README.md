...
![high-level-sys-design](/assets/images/system-design/high-level-sys-design.png)
...
![video-uploading-flow](/assets/images/system-design/video-uploading-flow.png)
...
![metadata-update-flow](/assets/images/system-design/metadata-update-flow.png)
...
![video-streaming-flow](/assets/images/system-design/video-streaming-flow.png)
...
![dag-model](/assets/images/system-design/dag-model.png)
...
![video-encodings](/assets/images/system-design/video-encodings.png)

## Video transcoding architecture
![video-transcoding-architecture](/assets/images/system-design/video-transcoding-architecture.png)

### Preprocessor
![preprocessor](/assets/images/system-design/preprocessor.png)
...
![dag-config-example](/assets/images/system-design/dag-config-example.png)

### DAG Scheduler
![dag-scheduler](/assets/images/system-design/dag-scheduler.png)

DAG scheduler splits a DAG into stages of tasks and puts them in a task queue, managed by a resource manager:
![dag-split-example](/assets/images/system-design/dag-split-example.png)

In this example, a video is split into video, audio and metadata stages which are processed in parallel.

### Resource manager
![resource-manager](/assets/images/system-design/resource-manager.png)

Resource manager is responsible for optimizing resource allocation.
![resource-manager-deep-dive](/assets/images/system-design/resource-manager-deep-dive.png)
...
### Task workers
![task-workers](/assets/images/system-design/task-workers.png)
...
![task-workers-example](/assets/images/system-design/task-workers-example.png)

### Temporary storage
![temporary-storage](/assets/images/system-design/temporary-storage.png)
...
### Encoded video
![encoded-video](/assets/images/system-design/encoded-video.png)
...
![video-uploading-optimization](/assets/images/system-design/video-uploading-optimization.png)

This enables fast resumable uploads if something goes wrong. Splitting the video file is done by the client.

### Speed optimization - place upload centers close to users
![upload-centers](/assets/images/system-design/upload-centers.png)
...
![no-parralelism-components](/assets/images/system-design/no-parralelism-components.png)
...
![parralelism-components](/assets/images/system-design/parralelism-components.png)

### Safety optimization - pre-signed upload URL
To avoid unauthorized users from uploading videos, we introduce pre-signed upload URLs:
![presigned-upload-url](/assets/images/system-design/presigned-upload-url.png)
...
![cdn-optimization](/assets/images/system-design/cdn-optimization.png)
