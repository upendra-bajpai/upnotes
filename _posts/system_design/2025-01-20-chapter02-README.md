...
![single-server-setup](/assets/images/system-design/single-server-setup.png)
...
![database-separate-from-web](/assets/images/system-design/database-separate-from-web.png)
...
![load-balancer-example](/assets/images/system-design/load-balancer-example.png)
...
![master-slave-replication](/assets/images/system-design/master-slave-replication.png)
...
![master-slave-db-replication](/assets/images/system-design/master-slave-db-replication.png)
...
![cache-tier](/assets/images/system-design/cache-tier.png)
...
![cdn](/assets/images/system-design/cdn.png)

Here's the request flow:
![cdn-request-flow](/assets/images/system-design/cdn-request-flow.png)
...
![web-app-design-after-cdn](/assets/images/system-design/web-app-design-after-cdn.png)
...
![stateful-servers](/assets/images/system-design/stateful-servers.png)
...
![stateless-architecture](/assets/images/system-design/stateless-architecture.png)
...
![web-app-architecture-updated](/assets/images/system-design/web-app-architecture-updated.png)
...
# Data centers
![data-centers](/assets/images/system-design/data-centers.png)
...
![data-center-failover](/assets/images/system-design/data-center-failover.png)
...
![message-queue](/assets/images/system-design/message-queue.png)
...
![photo-processing-queue](/assets/images/system-design/photo-processing-queue.png)
...
![sys-design-after-monitoring](/assets/images/system-design/sys-design-after-monitoring.png)
...
![vertical-vs-horizontal-scaling](/assets/images/system-design/vertical-vs-horizontal-scaling.png)
...
![database-sharding](/assets/images/system-design/database-sharding.png)

Here's how the user data looks like in this example:
![user-data-in-shards](/assets/images/system-design/user-data-in-shards.png)
...
![updated-system-design](/assets/images/system-design/updated-system-design.png)
