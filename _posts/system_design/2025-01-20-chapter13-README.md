...
![store-relay-message](/assets/images/system-design/store-relay-message.png)
...
![polling](/assets/images/system-design/polling.png)

This is easy to implement but it can be costly as there are many requests, which often yield no results

## Long polling
![long-polling](/assets/images/system-design/long-polling.png)
...
![web-sockets](/assets/images/system-design/web-sockets.png)
...
![refined-high-level-design](/assets/images/system-design/refined-high-level-design.png)
...
![one-on-one-chat-table](/assets/images/system-design/one-on-one-chat-table.png)
...
![group-chat-table](/assets/images/system-design/group-chat-table.png)
...
![service-discovery](/assets/images/system-design/service-discovery.png)
...
### 1 on 1 chat flow
![one-on-one-chat-flow](/assets/images/system-design/one-on-one-chat-flow.png)
...
![message-sync](/assets/images/system-design/message-sync.png)
...
![group-chat-flow](/assets/images/system-design/group-chat-flow.png)
...
![recipient-group-chat](/assets/images/system-design/recipient-group-chat.png)
...
![user-login-online](/assets/images/system-design/user-login-online.png)
...
![user-logout-offline](/assets/images/system-design/user-logout-offline.png)
...
![user-heartbeat](/assets/images/system-design/user-heartbeat.png)
...
![presence-status-fanout](/assets/images/system-design/presence-status-fanout.png)
