---
layout: post
title:  "Chapter-13 - intrinsic-vs-explicit-locks"
author: sal
date: 2025-01-21-00:18:14
categories: [tutorial, intrinsic-vs-explicit-locks,java]
image: assets/images/java/intrinsic-vs-explicit-locks.png
---
...
{% include image.html src="assets/images/java/intrinsic-vs-explicit-locks.png" alt="Intrinsic vs. Explicit locks performance" caption="" %}
...
{% include image.html src="assets/images/java/unfair-vs-fair-locking.png" alt="Unfair vs. Fair locking" caption="" %}
