---
layout: post
title:  "Chapter-15 - high-contention-performance"
author: sal
date: 2025-01-21-00:18:14
categories: [tutorial, high-contention-performance,java]
image: assets/images/java/high-contention-performance.png
---
...
{% include image.html src="assets/images/java/high-contention-performance.png" alt="High contention performance comparison" caption="" %}

Performance comparison under moderate contention:
{% include image.html src="assets/images/java/moderate-contention-performance.png" alt="Moderate contention performance comparison" caption="" %}
