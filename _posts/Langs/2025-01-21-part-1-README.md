---
layout: post
title:  "Part-1 - engineering-staff-growth"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, engineering-staff-growth,architecture]
image: assets/images/architecture/engineering-staff-growth.png
---
# Part 1 - Introduction
...
{% include image.html src="assets/images/architecture/engineering-staff-growth.png" alt="Engineering staff growth" caption="" %}

Here's a graphic of the company's productivity measured in simple lines of code:
{% include image.html src="assets/images/architecture/loc-productivity.png" alt="Productivity via LOC" caption="" %}

Finally, taking this altogether produces the $ cost per LOC for the company:
{% include image.html src="assets/images/architecture/dollar-cost-per-loc.png" alt="Dollar cost per LOC" caption="" %}
...
{% include image.html src="assets/images/architecture/productivity-per-release.png" alt="Productivity per release" caption="" %}
...
{% include image.html src="assets/images/architecture/monthly-payroll-per-release.png" alt="Monthly Payroll per Release" caption="" %}
...
{% include image.html src="assets/images/architecture/tdd-vs-no-tdd.png" alt="TDD vs. No TDD" caption="" %}
...
### Eisenhower's Matrix
{% include image.html src="assets/images/architecture/eisenhowers-matrix.png" alt="Image" caption="" %}
