---
layout: post
title:  "03.Factory-Method - factory-method-example"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, factory-method-example,architecture]
image: assets/images/architecture/factory-method-example.png
---
# Factory Method
...
Example:
{% include image.html src="assets/images/architecture/factory-method-example.png" alt="Factory Method Example" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/structure-factory-method.png" alt="Factory Method Structure" caption="" %}
...
{% include image.html src="assets/images/architecture/parallel-cls-hierarchies.png" alt="Parallel class hierarchies example" caption="" %}
