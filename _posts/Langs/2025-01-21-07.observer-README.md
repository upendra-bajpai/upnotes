---
layout: post
title:  "07.Observer - excel-example"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, excel-example,architecture]
image: assets/images/architecture/excel-example.png
---
# Observer
...
{% include image.html src="assets/images/architecture/excel-example.png" alt="excel-example" caption="" %}
...
Example interaction:
{% include image.html src="assets/images/architecture/interaction-example.png" alt="interaction-example" caption="" %}
...
Example structure:
{% include image.html src="assets/images/architecture/change-manager-structure.png" alt="change-manager-structure" caption="" %}
