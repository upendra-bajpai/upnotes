---
layout: post
title:  "04.Iterator - example-list-iterator"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, example-list-iterator,architecture]
image: assets/images/architecture/example-list-iterator.png
---
# Iterator
...
{% include image.html src="assets/images/architecture/example-list-iterator.png" alt="example-list-iterator" caption="" %}
...
{% include image.html src="assets/images/architecture/abstract-list-iteraot.png" alt="abstract-list-iterator" caption="" %}
