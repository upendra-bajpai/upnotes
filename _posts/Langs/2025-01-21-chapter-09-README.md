---
layout: post
title:  "Chapter-09 - short-running-task-example"
author: sal
date: 2025-01-21-00:18:14
categories: [tutorial, short-running-task-example,java]
image: assets/images/java/short-running-task-example.png
---
...
{% include image.html src="assets/images/java/short-running-task-example.png" alt="Short running task control flow" caption="" %}
...
{% include image.html src="assets/images/java/short-running-task-complex-example.png" alt="Short running task (complex example) control flow" caption="" %}
