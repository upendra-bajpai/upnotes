---
layout: post
title:  "02.Builder - rtf-reader-class-diagram"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, rtf-reader-class-diagram,architecture]
image: assets/images/architecture/rtf-reader-class-diagram.png
---
# Builder
...
{% include image.html src="assets/images/architecture/rtf-reader-class-diagram.png" alt="RTF Reader Class Diagram" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/builder-pattern-structure.png" alt="Structure of Builder pattern" caption="" %}
...
{% include image.html src="assets/images/architecture/builder-sequence-diagram.png" alt="Builder Sequence Diagram" caption="" %}
