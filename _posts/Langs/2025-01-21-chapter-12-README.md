---
layout: post
title:  "Chapter-12 - bounder-buffer-performance"
author: sal
date: 2025-01-21-00:18:14
categories: [tutorial, bounder-buffer-performance,java]
image: assets/images/java/bounder-buffer-performance.png
---
...
{% include image.html src="assets/images/java/bounder-buffer-performance.png" alt="Bounded buffer performance" caption="" %}
...
{% include image.html src="assets/images/java/bounded-buffers-comparison.png" alt="Bounded buffers comparison" caption="" %}

## Measuring responsiveness
To measure responsiveness, you can create a histogram showing the variance in response times of a single task:
{% include image.html src="assets/images/java/bounded-buffer-measurements.png" alt="Bounded buffer measurements" caption="" %}
...
{% include image.html src="assets/images/java/single-item-buffer-measurements.png" alt="Single item buffer measurements" caption="" %}
...
{% include image.html src="assets/images/java/dynamic-compilation-impact.png" alt="Dynamic compilation performance impact" caption="" %}
