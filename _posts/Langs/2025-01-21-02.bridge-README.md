---
layout: post
title:  "02.Bridge - window-inheritance"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, window-inheritance,architecture]
image: assets/images/architecture/window-inheritance.png
---
# Bridge
...
{% include image.html src="assets/images/architecture/window-inheritance.png" alt="Window inheritance diagram" caption="" %}
...
{% include image.html src="assets/images/architecture/bridge-example.png" alt="Bridge example" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/bridge-structure.png" alt="Bridge Structure" caption="" %}
