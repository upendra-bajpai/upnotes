---
layout: post
title:  "Part-2 - no-dependency-inversion"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, no-dependency-inversion,architecture]
image: assets/images/architecture/no-dependency-inversion.png
---
...
{% include image.html src="assets/images/architecture/no-dependency-inversion.png" alt="Flow of control without dependency inversion" caption="" %}
...
{% include image.html src="assets/images/architecture/dependency-inversion.png" alt="Dependency Inversion" caption="" %}
...
{% include image.html src="assets/images/architecture/independent-business-rules.png" alt="Business rules independent of low-level details" caption="" %}
