---
layout: post
title:  "Java - serialize_deserialize_java"
author: sal
date: 2025-01-23-21:07:40
categories: [tutorial, serialize_deserialize_java,java]
image: assets/images/java/serialize_deserialize_java.png
---
# Serializable interface
Serialization is a mechanism of converting the state of an object into a byte stream. Deserialization is the reverse process where the byte stream is used to recreate the actual Java object in memory. This mechanism is used to persist the object.

{% include image.html src="assets/images/java/serialize_deserialize_java.png" alt="" caption="" %}
