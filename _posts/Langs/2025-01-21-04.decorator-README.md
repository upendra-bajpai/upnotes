---
layout: post
title:  "04.Decorator - decorator-example"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, decorator-example,architecture]
image: assets/images/architecture/decorator-example.png
---
# Decorator
...
{% include image.html src="assets/images/architecture/decorator-example.png" alt="Decorator Example" caption="" %}

And here's the structure of the classes:
{% include image.html src="assets/images/architecture/decorator-example-structure.png" alt="Decorator Example Structure" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/decorator-structure.png" alt="Decorator Structure" caption="" %}
...
{% include image.html src="assets/images/architecture/decorator-extended-functionality.png" alt="Decorator extended functionality" caption="" %}

Example strategy structure:
{% include image.html src="assets/images/architecture/strategy-extended-functionality.png" alt="Strategy extended functionality" caption="" %}
