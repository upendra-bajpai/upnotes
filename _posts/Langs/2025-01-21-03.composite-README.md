---
layout: post
title:  "03.Composite - composite-example-structure"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, composite-example-structure,architecture]
image: assets/images/architecture/composite-example-structure.png
---
# Composite
## Intent
...
{% include image.html src="assets/images/architecture/composite-example-structure.png" alt="Composite Structure example" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/composite-structure.png" alt="Composite structure" caption="" %}

This is how a typical composite structure looks like:
{% include image.html src="assets/images/architecture/composite-structure-example-2.png" alt="Composite structure example" caption="" %}
