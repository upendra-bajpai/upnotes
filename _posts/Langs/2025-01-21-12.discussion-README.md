---
layout: post
title:  "12.Discussion - command-example"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, command-example,architecture]
image: assets/images/architecture/command-example.png
---
...
{% include image.html src="assets/images/architecture/command-example.png" alt="command-example" caption="" %}
...
{% include image.html src="assets/images/architecture/observer-example.png" alt="observer-example" caption="" %}
...
{% include image.html src="assets/images/architecture/cor-example.png" alt="cor-example" caption="" %}
