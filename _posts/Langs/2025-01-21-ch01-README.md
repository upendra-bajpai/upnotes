---
layout: post
title:  "Ch01 - dp-catalog"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, dp-catalog,architecture]
image: assets/images/architecture/dp-catalog.png
---
# Introduction
...
{% include image.html src="assets/images/architecture/dp-catalog.png" alt="Design Patterns Catalog" caption="" %}
...
{% include image.html src="assets/images/architecture/class-definition.png" alt="Class Definition" caption="" %}

Dashed Line - class instantiates objects of another class:
{% include image.html src="assets/images/architecture/uml-class-instantiating-objects.png" alt="Class Instantiating Objects" caption="" %}

Line with arrow in the middle - inheritance:
{% include image.html src="assets/images/architecture/uml-inheritance-example.png" alt="Inheritance Example" caption="" %}

Abstract classes are written in italic. Dog-eared box represents example implementation in pseudocode:
{% include image.html src="assets/images/architecture/uml-abstract-class-example.png" alt="Abstract Class + example implementation" caption="" %}

Mixin - provide optional interface of functionality through multiple inheritance:
{% include image.html src="assets/images/architecture/uml-mixin-example.png" alt="Mixin Example" caption="" %}
...
Example:
{% include image.html src="assets/images/architecture/delegate-example.png" alt="Delegate Example" caption="" %}
...
{% include image.html src="assets/images/architecture/when-to-use-design-patterns.png" alt="When to use design patterns" caption="" %}
