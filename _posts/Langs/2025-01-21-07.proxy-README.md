---
layout: post
title:  "07.Proxy - proxy-example-structure"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, proxy-example-structure,architecture]
image: assets/images/architecture/proxy-example-structure.png
---
# Proxy
...
{% include image.html src="assets/images/architecture/proxy-example-structure.png" alt="Proxy example structure" caption="" %}
...
{% include image.html src="assets/images/architecture/image-proxy-example.png" alt="Image proxy example" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/proxy-structure.png" alt="Proxy structure" caption="" %}
