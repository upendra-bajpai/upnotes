---
layout: post
title:  "01.Adapter - object-adapter-example"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, object-adapter-example,architecture]
image: assets/images/architecture/object-adapter-example.png
---
# Adapter
...
{% include image.html src="assets/images/architecture/object-adapter-example.png" alt="Object Adapter Example" caption="" %}
...
## Structure
Class Adapter:
{% include image.html src="assets/images/architecture/class-adapter.png" alt="Class Adapter" caption="" %}

Object Adapter:
{% include image.html src="assets/images/architecture/object-adapter.png" alt="Object Adapter" caption="" %}
...
{% include image.html src="assets/images/architecture/two-way-adapter.png" alt="Two-way adapter example" caption="" %}
...
{% include image.html src="assets/images/architecture/pluggable-adapters-1.png" alt="Pluggable adapters example" caption="" %}
...
{% include image.html src="assets/images/architecture/pluggable-adapters-delegate.png" alt="Pluggable adapters with Delegate" caption="" %}
