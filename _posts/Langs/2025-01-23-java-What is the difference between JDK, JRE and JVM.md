...
{% include image.html src="assets/images/java/jdk.png" alt="" caption="" %}")
...
{% include image.html src="assets/images/java/jre.png" alt="" caption="" %}")
