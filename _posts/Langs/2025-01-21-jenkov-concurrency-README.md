---
layout: post
title:  "Jenkov-Concurrency - cpus-multiple-threads"
author: sal
date: 2025-01-21-00:18:14
categories: [tutorial, cpus-multiple-threads,java]
image: assets/images/java/cpus-multiple-threads.png
---
...
{% include image.html src="assets/images/java/cpus-multiple-threads.png" alt="CPUs with multiple threads" caption="" %}
...
{% include image.html src="assets/images/java/shared-state.png" alt="shared state" caption="" %}

Separate state -> threads use their own state which is shared via immutable objects or copies
{% include image.html src="assets/images/java/separate-state.png" alt="separate state" caption="" %}

### Parallel Workers
{% include image.html src="assets/images/java/parallel-workers.png" alt="parallel workers" caption="" %}
...
{% include image.html src="assets/images/java/assembly-line.png" alt="assembly line" caption="" %}

These systems are usually designed to use non-blocking IO and the non-blocking IO is the boundary between the workers.
{% include image.html src="assets/images/java/assembly-line-io.png" alt="assembly line io" caption="" %}
...
{% include image.html src="assets/images/java/actor-model.png" alt="actor model" caption="" %}

In the channels model, each worker subscribes to messages on a channel which other workers can send messages to.
{% include image.html src="assets/images/java/channels-model.png" alt="channels model" caption="" %}
...
{% include image.html src="assets/images/java/single-threaded-system.png" alt="Single-threaded system" caption="" %}

### Same-threading == single-threading scaled out
{% include image.html src="assets/images/java/same-threading.png" alt="Same Threading" caption="" %}

Multi-threaded system == a lot of threads which share state.
Same-threaded system == a lot of threads not sharing any state.
{% include image.html src="assets/images/java/multi-vs-same-threading.png" alt="Multi-threading vs. same-threading" caption="" %}
...
{% include image.html src="assets/images/java/concurrency].png" alt="Concurrency" caption="" %}

Parallel execution == Program is making progress on more than one task in parallel.
{% include image.html src="assets/images/java/parallel-execution.png" alt="Parallel execution" caption="" %}

Parallel concurrent execution == N tasks on M CPUs where N > M.
{% include image.html src="assets/images/java/parallel-concurrent-execution.png" alt="Parallel Concurrent Execution" caption="" %}

Parallelism == big task is split into subtasks which are executed concurrently and/or in parallel:
{% include image.html src="assets/images/java/parallelism.png" alt="Parallelism" caption="" %}
...
{% include image.html src="assets/images/java/thread-loop.png" alt="thread loop" caption="" %}

Agent - a component which does some work & is invoked by the thread loop.
Thread loops invoke agents:
{% include image.html src="assets/images/java/thread-loop-agent.png" alt="Thread loop with agent" caption="" %}
...
Internal JMM:
{% include image.html src="assets/images/java/java-memory-model.png" alt="Java Memory Model" caption="" %}

How the JMM maps to the hardware memory model:
{% include image.html src="assets/images/java/jmm-to-hardware-mapping.png" alt="JMM to Hardware MM mapping" caption="" %}
...
{% include image.html src="assets/images/java/visibility-problem.png" alt="Visibility problem" caption="" %}
...
{% include image.html src="assets/images/java/race-condition.png" alt="Race Condition" caption="" %}
...
{% include image.html src="assets/images/java/visibility-problem-2.png" alt="Visibility problem" caption="" %}
...
{% include image.html src="assets/images/java/cpu-cache-coherence.png" alt="CPU Cache Coherence" caption="" %}
...
{% include image.html src="assets/images/java/blocking-queue.png" alt="Blocking queue" caption="" %}
...
{% include image.html src="assets/images/java/foreground-thread-latency.png" alt="Foreground thread latency" caption="" %}
...
{% include image.html src="assets/images/java/thread-pool.png" alt="Thread pool" caption="" %}
...
{% include image.html src="assets/images/java/locking-example.png" alt="Locking visualization" caption="" %}
...
{% include image.html src="assets/images/java/CAS-example.png" alt="cas example" caption="" %}
...
{% include image.html src="assets/images/java/blocking-algo.png" alt="Blocking algorithm" caption="" %}
...
{% include image.html src="assets/images/java/nonblocking-algo.png" alt="Nonblocking algorithm" caption="" %}
...
### The law illustrated
{% include image.html src="assets/images/java/amdahl-law-1.png" alt="Amdahl's law 1" caption="" %}

If parallelization is 2:
{% include image.html src="assets/images/java/amdahl-law-2.png" alt="Amdahl's law 2" caption="" %}

If parallelization is 3:
{% include image.html src="assets/images/java/amdahl-law-3.png" alt="Amdahl's law 3" caption="" %}
