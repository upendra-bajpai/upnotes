---
layout: post
title:  "05.Facade - facade-conceptual-example"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, facade-conceptual-example,architecture]
image: assets/images/architecture/facade-conceptual-example.png
---
# Facade
...
{% include image.html src="assets/images/architecture/facade-conceptual-example.png" alt="Facade conceptual example" caption="" %}
...
{% include image.html src="assets/images/architecture/compiler-example.png" alt="Compiler example" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/facade-structure.png" alt="Facade Structure" caption="" %}
