---
layout: post
title:  "01.Chain-Of-Responsibility - cor-example-chaining"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, cor-example-chaining,architecture]
image: assets/images/architecture/cor-example-chaining.png
---
...
{% include image.html src="assets/images/architecture/cor-example-chaining.png" alt="cor-example-chaining" caption="" %}

The first object in the chain receives the request and either handles it or forwards it.
{% include image.html src="assets/images/architecture/cor-execution-example.png" alt="cor-execution-example" caption="" %}
...
{% include image.html src="assets/images/architecture/cor-example-structure.png" alt="cor-example-structure" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/cor-structure.png" alt="cor-structure" caption="" %}
