---
layout: post
title:  "Rx - creating_create"
author: sal
date: 2025-01-23-21:09:33
categories: [tutorial, creating_create,Rx]
image: assets/images/Rx/creating_create.png
---
# Creating Operators
...
{% include image.html src="assets/images/Rx/creating_create.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_defer.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_empty.png" alt="" caption="" %}

- `Never` - create an `Observable` that emits no items and does not terminate;
{% include image.html src="assets/images/Rx/creating_never.png" alt="" caption="" %}

- `Throw` - create an `Observable` that emits no items and terminates with an error.
{% include image.html src="assets/images/Rx/creating_throw.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_from.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_interval.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_just.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_range.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_repeat.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_start.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/creating_timer.png" alt="" caption="" %}
