---
layout: post
title:  "Rx - utility_subscribeon"
author: sal
date: 2025-01-23-21:09:33
categories: [tutorial, utility_subscribeon,Rx]
image: assets/images/Rx/utility_subscribeon.png
---
# SubscribeOn
`SubscribeOn` specify the Scheduler on which an Observable will operate.

{% include image.html src="assets/images/Rx/utility_subscribeon.png" alt="" caption="" %}
...
{% include image.html src="assets/images/Rx/utility_schedulers.png" alt="" caption="" %}
