---
layout: post
title:  "06.Flyweight - naive-structure"
author: sal
date: 2025-01-21-00:24:53
categories: [tutorial, naive-structure,architecture]
image: assets/images/architecture/naive-structure.png
---
# Flyweight
...
{% include image.html src="assets/images/architecture/naive-structure.png" alt="Naive structure example" caption="" %}
...
{% include image.html src="assets/images/architecture/flyweight-logical-structure.png" alt="Flyweight logical structure" caption="" %}

Example flyweight physical representation:
{% include image.html src="assets/images/architecture/flyweight-physical-structure.png" alt="Flyweight physical structure" caption="" %}

Example class structure of the above:
{% include image.html src="assets/images/architecture/flyweight-example-cls-structure.png" alt="Flyweight class structure" caption="" %}
...
## Structure
{% include image.html src="assets/images/architecture/flyweight-structure.png" alt="Flyweight structure" caption="" %}

Example sharing of flyweight objects:
{% include image.html src="assets/images/architecture/flyweight-sharing-exmaple.png" alt="Flyweight sharing example" caption="" %}
