---
layout: post
title:  "Android - spannable_table"
author: sal
date: 2025-01-23-21:23:30
categories: [tutorial, spannable_table,android]
image: assets/images/android/spannable_table.png
---
# Spannable
...
{% include image.html src="assets/images/android/spannable_table.png" alt="" caption="" %}
...
{% include image.html src="assets/images/android/appearance_affecting_spans.png" alt="" caption="" %}
...
{% include image.html src="assets/images/android/metric_affecting_spans.png" alt="" caption="" %}
...
{% include image.html src="assets/images/android/paragraph_affecting_spans.png" alt="" caption="" %}
