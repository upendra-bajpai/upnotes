---
layout: post
title:  "Chapter25 - storage-comparison"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, storage-comparison,system design]
image: assets/images/system-design/storage-comparison.png
---
...
{% include image.html src="assets/images/system-design/storage-comparison.png" alt="storage-comparison" caption="" %}
...
{% include image.html src="assets/images/system-design/object-store-vs-unix.png" alt="object-store-vs-unix" caption="" %}

By separating metadata from file contents, we can scale the different stores independently:
{% include image.html src="assets/images/system-design/bucket-and-object.png" alt="bucket-and-object" caption="" %}
...
## Uploading an object
{% include image.html src="assets/images/system-design/uploading-object.png" alt="uploading-object" caption="" %}
...
{% include image.html src="assets/images/system-design/download-object.png" alt="download-object" caption="" %}
...
{% include image.html src="assets/images/system-design/data-store-interactions.png" alt="data-store-interactions" caption="" %}

The data store's main components:
{% include image.html src="assets/images/system-design/data-store-main-components.png" alt="data-store-main-components" caption="" %}
...
{% include image.html src="assets/images/system-design/virtual-cluster-map.png" alt="virtual-cluster-map" caption="" %}
...
{% include image.html src="assets/images/system-design/data-persistence-flow.png" alt="data-persistence-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/consistency-vs-latency.png" alt="consistency-vs-latency" caption="" %}
...
{% include image.html src="assets/images/system-design/wal-optimization.png" alt="wal-optimization" caption="" %}
...
{% include image.html src="assets/images/system-design/updated-data-persistence-flow.png" alt="updated-data-persistence-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/failure-domain-isolation.png" alt="failure-domain-isolation" caption="" %}
...
{% include image.html src="assets/images/system-design/erasure-coding.png" alt="erasure-coding" caption="" %}
...
{% include image.html src="assets/images/system-design/erasure-coding-across-failure-domains.png" alt="erasure-coding-across-failure-domains" caption="" %}
...
{% include image.html src="assets/images/system-design/erasure-coding-vs-replication.png" alt="erasure-coding-vs-replication" caption="" %}
...
{% include image.html src="assets/images/system-design/checksums-for-correctness.png" alt="checksums-for-correctness" caption="" %}
...
## Metadata data model
Table schemas:
{% include image.html src="assets/images/system-design/metadata-data-model.png" alt="metadata-data-model" caption="" %}
...
{% include image.html src="assets/images/system-design/object-versioning.png" alt="object-versioning" caption="" %}
...
{% include image.html src="assets/images/system-design/deleting-versioned-object.png" alt="deleting-versioned-object" caption="" %}
...
{% include image.html src="assets/images/system-design/multipart-upload.png" alt="multipart-upload" caption="" %}
...
{% include image.html src="assets/images/system-design/compaction.png" alt="compaction" caption="" %}
