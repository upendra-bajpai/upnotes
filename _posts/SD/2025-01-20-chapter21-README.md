...
![metrics-monitoring-core-components](/assets/images/system-design/metrics-monitoring-core-components.png)
...
![metrics-example-1](/assets/images/system-design/metrics-example-1.png)

The data can be identified by the following table:
![metrics-example-1-data](/assets/images/system-design/metrics-example-1-data.png)
...
![time-series-data-example](/assets/images/system-design/time-series-data-example.png)

A good way to visualize how data looks like:
![time-series-data-viz](/assets/images/system-design/time-series-data-viz.png)
...
![influxdb-scale](/assets/images/system-design/influxdb-scale.png)
...
![metrics-collection](/assets/images/system-design/metrics-collection.png)

There are two ways to implement metrics collection - pull or push.

Here's how the pull model might look like:
![pull-model-example](/assets/images/system-design/pull-model-example.png)
...
![service-discovery-example](/assets/images/system-design/service-discovery-example.png)

Here's a detailed explanation of the metrics collection flow:
![metrics-collection-flow](/assets/images/system-design/metrics-collection-flow.png)
...
![consistent-hash-ring](/assets/images/system-design/consistent-hash-ring.png)

With the push model, on the other hand, services push their metrics to the metrics collector proactively:
![push-model-example](/assets/images/system-design/push-model-example.png)
...
![metrics-collector-agent](/assets/images/system-design/metrics-collector-agent.png)
...
![metrics-transmission-pipeline](/assets/images/system-design/metrics-transmission-pipeline.png)
...
![queuing-mechanism](/assets/images/system-design/queuing-mechanism.png)
...
![metrics-collection-kafka](/assets/images/system-design/metrics-collection-kafka.png)
...
![cache-layer-query-service](/assets/images/system-design/cache-layer-query-service.png)
...
![double-delta-encoding](/assets/images/system-design/double-delta-encoding.png)
...
## Alerting system
![alerting-system](/assets/images/system-design/alerting-system.png)
...
![grafana-dashboard](/assets/images/system-design/grafana-dashboard.png)
...
![final-design](/assets/images/system-design/final-design.png)
