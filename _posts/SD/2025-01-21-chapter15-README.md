---
layout: post
title:  "Chapter15 - high-level-sys-design"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, high-level-sys-design,system design]
image: assets/images/system-design/high-level-sys-design.png
---
# Design YouTube
...
{% include image.html src="assets/images/system-design/high-level-sys-design.png" alt="high-level-sys-design" caption="" %}
...
{% include image.html src="assets/images/system-design/video-uploading-flow.png" alt="video-uploading-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/metadata-update-flow.png" alt="metadata-update-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/video-streaming-flow.png" alt="video-streaming-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/dag-model.png" alt="dag-model" caption="" %}
...
{% include image.html src="assets/images/system-design/video-encodings.png" alt="video-encodings" caption="" %}

## Video transcoding architecture
{% include image.html src="assets/images/system-design/video-transcoding-architecture.png" alt="video-transcoding-architecture" caption="" %}

### Preprocessor
{% include image.html src="assets/images/system-design/preprocessor.png" alt="preprocessor" caption="" %}
...
{% include image.html src="assets/images/system-design/dag-config-example.png" alt="dag-config-example" caption="" %}

### DAG Scheduler
{% include image.html src="assets/images/system-design/dag-scheduler.png" alt="dag-scheduler" caption="" %}

DAG scheduler splits a DAG into stages of tasks and puts them in a task queue, managed by a resource manager:
{% include image.html src="assets/images/system-design/dag-split-example.png" alt="dag-split-example" caption="" %}

In this example, a video is split into video, audio and metadata stages which are processed in parallel.

### Resource manager
{% include image.html src="assets/images/system-design/resource-manager.png" alt="resource-manager" caption="" %}

Resource manager is responsible for optimizing resource allocation.
{% include image.html src="assets/images/system-design/resource-manager-deep-dive.png" alt="resource-manager-deep-dive" caption="" %}
...
### Task workers
{% include image.html src="assets/images/system-design/task-workers.png" alt="task-workers" caption="" %}
...
{% include image.html src="assets/images/system-design/task-workers-example.png" alt="task-workers-example" caption="" %}

### Temporary storage
{% include image.html src="assets/images/system-design/temporary-storage.png" alt="temporary-storage" caption="" %}
...
### Encoded video
{% include image.html src="assets/images/system-design/encoded-video.png" alt="encoded-video" caption="" %}
...
{% include image.html src="assets/images/system-design/video-uploading-optimization.png" alt="video-uploading-optimization" caption="" %}

This enables fast resumable uploads if something goes wrong. Splitting the video file is done by the client.

### Speed optimization - place upload centers close to users
{% include image.html src="assets/images/system-design/upload-centers.png" alt="upload-centers" caption="" %}
...
{% include image.html src="assets/images/system-design/no-parralelism-components.png" alt="no-parralelism-components" caption="" %}
...
{% include image.html src="assets/images/system-design/parralelism-components.png" alt="parralelism-components" caption="" %}

### Safety optimization - pre-signed upload URL
To avoid unauthorized users from uploading videos, we introduce pre-signed upload URLs:
{% include image.html src="assets/images/system-design/presigned-upload-url.png" alt="presigned-upload-url" caption="" %}
...
{% include image.html src="assets/images/system-design/cdn-optimization.png" alt="cdn-optimization" caption="" %}
