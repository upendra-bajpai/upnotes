---
layout: post
title:  "Part00 - app-capacity"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, app-capacity,system design]
image: assets/images/system-design/app-capacity.png
---
# Introduction
...
{% include image.html src="assets/images/system-design/app-capacity.png" alt="app-capacity" caption="" %}
...
{% include image.html src="assets/images/system-design/availability-nines.png" alt="availability-nines" caption="" %}
...
{% include image.html src="assets/images/system-design/ports-and-adapters.png" alt="ports-and-adapters" caption="" %}
