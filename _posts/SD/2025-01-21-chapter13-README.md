---
layout: post
title:  "Chapter13 - store-relay-message"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, store-relay-message,system design]
image: assets/images/system-design/store-relay-message.png
---
...
{% include image.html src="assets/images/system-design/store-relay-message.png" alt="store-relay-message" caption="" %}
...
{% include image.html src="assets/images/system-design/polling.png" alt="polling" caption="" %}

This is easy to implement but it can be costly as there are many requests, which often yield no results

## Long polling
{% include image.html src="assets/images/system-design/long-polling.png" alt="long-polling" caption="" %}
...
{% include image.html src="assets/images/system-design/web-sockets.png" alt="web-sockets" caption="" %}
...
{% include image.html src="assets/images/system-design/refined-high-level-design.png" alt="refined-high-level-design" caption="" %}
...
{% include image.html src="assets/images/system-design/one-on-one-chat-table.png" alt="one-on-one-chat-table" caption="" %}
...
{% include image.html src="assets/images/system-design/group-chat-table.png" alt="group-chat-table" caption="" %}
...
{% include image.html src="assets/images/system-design/service-discovery.png" alt="service-discovery" caption="" %}
...
### 1 on 1 chat flow
{% include image.html src="assets/images/system-design/one-on-one-chat-flow.png" alt="one-on-one-chat-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/message-sync.png" alt="message-sync" caption="" %}
...
{% include image.html src="assets/images/system-design/group-chat-flow.png" alt="group-chat-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/recipient-group-chat.png" alt="recipient-group-chat" caption="" %}
...
{% include image.html src="assets/images/system-design/user-login-online.png" alt="user-login-online" caption="" %}
...
{% include image.html src="assets/images/system-design/user-logout-offline.png" alt="user-logout-offline" caption="" %}
...
{% include image.html src="assets/images/system-design/user-heartbeat.png" alt="user-heartbeat" caption="" %}
...
{% include image.html src="assets/images/system-design/presence-status-fanout.png" alt="presence-status-fanout" caption="" %}
