---
layout: post
title:  "Part01 - network-protocols"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, network-protocols,system design]
image: assets/images/system-design/network-protocols.png
---
# Communication
...
{% include image.html src="assets/images/system-design/network-protocols.png" alt="network-protocols" caption="" %}
...
{% include image.html src="assets/images/system-design/tcp-handshake.png" alt="tcp-handshake" caption="" %}
...
{% include image.html src="assets/images/system-design/tcp-receive-buffer.png" alt="tcp-receive-buffer" caption="" %}

The receive buffer size is also communicated back to the sender, who uses it to determine when to back-off:
{% include image.html src="assets/images/system-design/ack-receive-buffer-size.png" alt="ack-receive-buffer-size" caption="" %}
...
{% include image.html src="assets/images/system-design/congestion-window.png" alt="congestion-window" caption="" %}
...
{% include image.html src="assets/images/system-design/certificate-chain.png" alt="certificate-chain" caption="" %}
...
{% include image.html src="assets/images/system-design/dns-resolution-process.png" alt="dns-resolution-process" caption="" %}
...
{% include image.html src="assets/images/system-design/http-request-response-example.png" alt="http-request-response-example" caption="" %}
