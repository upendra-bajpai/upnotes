...
![partitioning-system](/assets/images/system-design/partitioning-system.png)
...
![map-projections](/assets/images/system-design/map-projections.png)
...
![geohashing](/assets/images/system-design/geohashing.png)
...
![road-representation](/assets/images/system-design/road-representation.png)
...
![routing-tiles](/assets/images/system-design/routing-tiles.png)
...
![map-routing-hierarchical](/assets/images/system-design/map-routing-hierarchical.png)
...
## Location service
![location-service](/assets/images/system-design/location-service.png)
...
![location-update-batches](/assets/images/system-design/location-update-batches.png)
...
![static-map-tiles](/assets/images/system-design/static-map-tiles.png)
...
![cdn-vs-no-cdn](/assets/images/system-design/cdn-vs-no-cdn.png)
...
![map-tile-url-calculation](/assets/images/system-design/map-tile-url-calculation.png)
...
Example row:
![user-location-data-row](/assets/images/system-design/user-location-data-torw.png)
...
![precomputed-map-tile-image](/assets/images/system-design/precomputed-map-tile-image.png)

## Services
### Location service
Let's focus on the database design and how user location is stored in detail for this service.
![location-service-diagram](/assets/images/system-design/location-service-diagram.png)
...
![user-location-row-example](/assets/images/system-design/user-location-row-example.png)
...
![location-update-streaming](/assets/images/system-design/location-update-streaming.png)
...
![zoom-level-increases](/assets/images/system-design/zoom-level-increases.png)
...
![navigation-service](/assets/images/system-design/navigation-service.png)
...
![shortest-path-service](/assets/images/system-design/shortest-path-service.png)
...
![adaptive-eta-data-storage](/assets/images/system-design/adaptive-eta-data-storage.png)
