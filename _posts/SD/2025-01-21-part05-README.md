---
layout: post
title:  "Part05 - test-pyramid"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, test-pyramid,system design]
image: assets/images/system-design/test-pyramid.png
---
# Maintainability
- [Testing](#testing)
...
{% include image.html src="assets/images/system-design/test-pyramid.png" alt="test-pyramid" caption="" %}
...
{% include image.html src="assets/images/system-design/sample-system-for-testing.png" alt="sample-system-for-testing" caption="" %}
...
{% include image.html src="assets/images/system-design/out-of-order-writes.png" alt="out-of-order-writes" caption="" %}
...
{% include image.html src="assets/images/system-design/deployment-stages.png" alt="deployment-stages" caption="" %}
...
{% include image.html src="assets/images/system-design/sli-example.png" alt="sli-example" caption="" %}
...
{% include image.html src="assets/images/system-design/slo-exmaple.png" alt="slo-example" caption="" %}
...
{% include image.html src="assets/images/system-design/dashboards-example.png" alt="dashboards-example" caption="" %}
...
{% include image.html src="assets/images/system-design/trace-example.png" alt="trace-example" caption="" %}
