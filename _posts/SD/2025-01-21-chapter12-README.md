---
layout: post
title:  "Chapter12 - feed-publishign"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, feed-publishign,system design]
image: assets/images/system-design/feed-publishign.png
---
...
## Feed publishing
{% include image.html src="assets/images/system-design/feed-publishign.png" alt="feed-publishing" caption="" %}
...
## Newsfeed building
{% include image.html src="assets/images/system-design/newsfeed-building.png" alt="newsfeed-building" caption="" %}
...
{% include image.html src="assets/images/system-design/feed-publishing-deep-dive.png" alt="feed-publishing-deep-dive" caption="" %}
...
{% include image.html src="assets/images/system-design/fanout-service.png" alt="fanout-service" caption="" %}
...
{% include image.html src="assets/images/system-design/news-feed-retrieval-deep-dive.png" alt="news-feed-retrieval-deep-dive" caption="" %}
 * user sends request to retrieve news feed.
...
{% include image.html src="assets/images/system-design/cache-layer.png" alt="cache-layer" caption="" %}
