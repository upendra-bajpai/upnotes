---
layout: post
title:  "Chapter21 - metrics-monitoring-core-components"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, metrics-monitoring-core-components,system design]
image: assets/images/system-design/metrics-monitoring-core-components.png
---
...
{% include image.html src="assets/images/system-design/metrics-monitoring-core-components.png" alt="metrics-monitoring-core-components" caption="" %}
...
{% include image.html src="assets/images/system-design/metrics-example-1.png" alt="metrics-example-1" caption="" %}

The data can be identified by the following table:
{% include image.html src="assets/images/system-design/metrics-example-1-data.png" alt="metrics-example-1-data" caption="" %}
...
{% include image.html src="assets/images/system-design/time-series-data-example.png" alt="time-series-data-example" caption="" %}

A good way to visualize how data looks like:
{% include image.html src="assets/images/system-design/time-series-data-viz.png" alt="time-series-data-viz" caption="" %}
...
{% include image.html src="assets/images/system-design/influxdb-scale.png" alt="influxdb-scale" caption="" %}
...
{% include image.html src="assets/images/system-design/metrics-collection.png" alt="metrics-collection" caption="" %}

There are two ways to implement metrics collection - pull or push.

Here's how the pull model might look like:
{% include image.html src="assets/images/system-design/pull-model-example.png" alt="pull-model-example" caption="" %}
...
{% include image.html src="assets/images/system-design/service-discovery-example.png" alt="service-discovery-example" caption="" %}

Here's a detailed explanation of the metrics collection flow:
{% include image.html src="assets/images/system-design/metrics-collection-flow.png" alt="metrics-collection-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/consistent-hash-ring.png" alt="consistent-hash-ring" caption="" %}

With the push model, on the other hand, services push their metrics to the metrics collector proactively:
{% include image.html src="assets/images/system-design/push-model-example.png" alt="push-model-example" caption="" %}
...
{% include image.html src="assets/images/system-design/metrics-collector-agent.png" alt="metrics-collector-agent" caption="" %}
...
{% include image.html src="assets/images/system-design/metrics-transmission-pipeline.png" alt="metrics-transmission-pipeline" caption="" %}
...
{% include image.html src="assets/images/system-design/queuing-mechanism.png" alt="queuing-mechanism" caption="" %}
...
{% include image.html src="assets/images/system-design/metrics-collection-kafka.png" alt="metrics-collection-kafka" caption="" %}
...
{% include image.html src="assets/images/system-design/cache-layer-query-service.png" alt="cache-layer-query-service" caption="" %}
...
{% include image.html src="assets/images/system-design/double-delta-encoding.png" alt="double-delta-encoding" caption="" %}
...
## Alerting system
{% include image.html src="assets/images/system-design/alerting-system.png" alt="alerting-system" caption="" %}
...
{% include image.html src="assets/images/system-design/grafana-dashboard.png" alt="grafana-dashboard" caption="" %}
