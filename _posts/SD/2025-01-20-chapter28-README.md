...
![digital-wallet](/assets/images/system-design/digital-wallet.png)
...
![wallet-service](/assets/images/system-design/wallet-service.png)
...
![distributed-transactions-relational-dbs](/assets/images/system-design/distributed-transactions-relational-dbs.png)

Here's how the two-phase commit (2PC) protocol works:
![2pc-protocol](/assets/images/system-design/2pc-protocol.png)
...
Phase 1 - try:
![try-phase](/assets/images/system-design/try-phase.png)
...
Phase 2a - confirm:
![confirm-phase](/assets/images/system-design/confirm-phase.png)
...
Phase 2b - cancel:
![cancel-phase](/assets/images/system-design/cancel-phase.png)
...
![phase-status-tables](/assets/images/system-design/phase-status-tables.png)
...
![unbalanced-state](/assets/images/system-design/unbalanced-state.png)
...
![out-of-order-execution](/assets/images/system-design/out-of-order-execution.png)
...
![saga](/assets/images/system-design/saga.png)
...
![event-sourcing](/assets/images/system-design/event-sourcing.png)

Here's a dynamic view of event sourcing:
![dynamic-event-sourcing](/assets/images/system-design/dynamic-event-sourcing.png)

For our wallet service, the commands are balance transfer requests. We can put them in a FIFO queue, such as Kafka:
![command-queue](/assets/images/system-design/command-queue.png)

Here's the full picture:
![wallet-service-state-machine](/assets/images/system-design/wallet-service-state-macghine.png)
...
![historical-states](/assets/images/system-design/historical-states.png)
...
![cqrs-architecture](/assets/images/system-design/cqrs-architecture.png)
...
![mmap-optimization](/assets/images/system-design/mmap-optimization.png)
...
![rocks-db-approach](/assets/images/system-design/rocks-db-approach.png)
...
![snapshot-approach](/assets/images/system-design/snapshot-approach.png)
...
![raft-replication](/assets/images/system-design/raft-replication.png)
...
![polling-approach](/assets/images/system-design/polling-approach.png)
...
![reverse-proxy](/assets/images/system-design/reverse-proxy.png)
...
![push-state-machines](/assets/images/system-design/push-state-machines.png)
...
![sharded-raft-groups](/assets/images/system-design/sharded-raft-groups.png)
