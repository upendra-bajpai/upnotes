---
layout: post
title:  "Chapter29 - world-stock-exchanges"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, world-stock-exchanges,system design]
image: assets/images/system-design/world-stock-exchanges.png
---
# Stock Exchange
...
{% include image.html src="assets/images/system-design/world-stock-exchanges.png" alt="world-stock-exchanges" caption="" %}
...
{% include image.html src="assets/images/system-design/l1-price.png" alt="l1-price" caption="" %}

L2 includes more price levels:
{% include image.html src="assets/images/system-design/l2-price.png" alt="l2-price" caption="" %}

L3 shows levels and queued quantity at each level:
{% include image.html src="assets/images/system-design/l3-price.png" alt="l3-price" caption="" %}

A candlestick shows the market open and close price, as well as the highest and lowest prices in the given interval:
{% include image.html src="assets/images/system-design/candlestick.png" alt="candlestick" caption="" %}
...
{% include image.html src="assets/images/system-design/sequencer.png" alt="sequencer" caption="" %}
...
{% include image.html src="assets/images/system-design/client-gateway.png" alt="client-gateway" caption="" %}
...
{% include image.html src="assets/images/system-design/client-gateways.png" alt="client-gateways" caption="" %}
...
{% include image.html src="assets/images/system-design/market-data.png" alt="market-data" caption="" %}

### Reporting flow
The reporter is not on the critical path, but it is an important component nevertheless.
{% include image.html src="assets/images/system-design/reporting-flow.png" alt="reporting-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/product-order-execution-data-model.png" alt="product-order-execution-data-model" caption="" %}
...
{% include image.html src="assets/images/system-design/order-book-execution.png" alt="order-book-execution" caption="" %}
...
{% include image.html src="assets/images/system-design/order-book-impl.png" alt="order-book-impl" caption="" %}
...
{% include image.html src="assets/images/system-design/mmap-bus.png" alt="mmap-bus" caption="" %}
...
{% include image.html src="assets/images/system-design/application-loop.png" alt="application-loop" caption="" %}
...
{% include image.html src="assets/images/system-design/design-so-far.png" alt="design-so-far" caption="" %}
...
{% include image.html src="assets/images/system-design/sequencer-deep-dive.png" alt="sequencer-deep-dive" caption="" %}
...
{% include image.html src="assets/images/system-design/leader-election.png" alt="leader-election" caption="" %}
...
{% include image.html src="assets/images/system-design/replication-across-servers.png" alt="replication-across-servers" caption="" %}

Example leader-election terms:
{% include image.html src="assets/images/system-design/leader-election-terms.png" alt="leader-election-terms" caption="" %}
...
{% include image.html src="assets/images/system-design/determinism.png" alt="determinism" caption="" %}
...
{% include image.html src="assets/images/system-design/market-data-publisher.png" alt="market-data-publisher" caption="" %}
