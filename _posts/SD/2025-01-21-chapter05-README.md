---
layout: post
title:  "Chapter05 - server-side-rate-limiter"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, server-side-rate-limiter,system design]
image: assets/images/system-design/server-side-rate-limiter.png
---
...
Server-side:
{% include image.html src="assets/images/system-design/server-side-rate-limiter.png" alt="server-side-rate-limiter" caption="" %}

As a middleware between client and server:
{% include image.html src="assets/images/system-design/middleware-rate-limiter.png" alt="middleware-rate-limiter" caption="" %}

How it works, assuming 2 requests per second are allowed:
{% include image.html src="assets/images/system-design/middleware-rate-limiter-example.png" alt="middleware-rate-limiter-example" caption="" %}
...
{% include image.html src="assets/images/system-design/token-bucket-algo.png" alt="token-bucket-algo" caption="" %}
...
{% include image.html src="assets/images/system-design/token-bucket-algo-explained.png" alt="token-bucket-algo-explained" caption="" %}
...
{% include image.html src="assets/images/system-design/leaking-bucket-algo.png" alt="leaking-bucket-algo" caption="" %}
...
{% include image.html src="assets/images/system-design/fixed-window-counter-algo.png" alt="fixed-window-counter-algo" caption="" %}
...
{% include image.html src="assets/images/system-design/traffic-burst-problem.png" alt="traffic-burst-problem" caption="" %}
...
{% include image.html src="assets/images/system-design/sliding-window-log-algo.png" alt="sliding-window-log-algo" caption="" %}
...
{% include image.html src="assets/images/system-design/sliding-window-counter-algo.png" alt="sliding-window-counter-algo" caption="" %}
...
{% include image.html src="assets/images/system-design/lyft-rate-limiting-rules.png" alt="lyft-rate-limiting-rules" caption="" %}

Another example \w max login attempts in a minute:
{% include image.html src="assets/images/system-design/lyft-rate-limiting-auth-rules.png" alt="lyft-rate-limiting-auth-rules" caption="" %}
...
## Detailed design
{% include image.html src="assets/images/system-design/detailed-design.png" alt="detailed-design" caption="" %}
...
{% include image.html src="assets/images/system-design/race-condition.png" alt="race-condition" caption="" %}
...
{% include image.html src="assets/images/system-design/synchronization-issue.png" alt="synchronization-issue" caption="" %}

To solve this issue, we can use a centralized data store (eg Redis) so that the rate limiter instances are stateless.
{% include image.html src="assets/images/system-design/redis-centralized-data-store.png" alt="redis-centralized-data-store" caption="" %}
