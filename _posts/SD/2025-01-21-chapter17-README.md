---
layout: post
title:  "Chapter17 - business-table"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, business-table,system design]
image: assets/images/system-design/business-table.png
---
# Proximity Service
...
{% include image.html src="assets/images/system-design/business-table.png" alt="business-table" caption="" %}
...
{% include image.html src="assets/images/system-design/high-level-deisgn.png" alt="high-level-design" caption="" %}
...
{% include image.html src="assets/images/system-design/2d-search.png" alt="2d-search" caption="" %}
...
{% include image.html src="assets/images/system-design/2d-query-problem.png" alt="2d-query-problem" caption="" %}

We can, however, build 2D indexes and there are different approaches to that:
{% include image.html src="assets/images/system-design/2d-index-options.png" alt="2d-index-options" caption="" %}
...
{% include image.html src="assets/images/system-design/evenly-divided-grid.png" alt="evenly-divided-grid" caption="" %}
...
{% include image.html src="assets/images/system-design/geohash-example.png" alt="geohash-example" caption="" %}
...
{% include image.html src="assets/images/system-design/geohash-precision.png" alt="geohash-precision" caption="" %}

Geohashes enable us to quickly locate neighboring regions based on a substring of the geohash:
{% include image.html src="assets/images/system-design/geohash-substrint.png" alt="geohash-substring" caption="" %}
...
{% include image.html src="assets/images/system-design/boundary-issue-geohash.png" alt="boundary-issue-geohash" caption="" %}
...
{% include image.html src="assets/images/system-design/geohash-boundary-issue-2.png" alt="geohash-boundary-issue-2" caption="" %}
...
{% include image.html src="assets/images/system-design/geohash-expansion.png" alt="geohash-expansion" caption="" %}
...
{% include image.html src="assets/images/system-design/quadtree-example.png" alt="quadtree-example" caption="" %}

This is an in-memory solution which can't easily be implemented in a database.

Here's how it might look conceptually:
{% include image.html src="assets/images/system-design/quadtree-concept.png" alt="quadtree-concept" caption="" %}
...
{% include image.html src="assets/images/system-design/denver-quadtree.png" alt="denver-quadtree" caption="" %}
...
{% include image.html src="assets/images/system-design/hilbert-curbe.png" alt="hilbert-curve" caption="" %}

This library is great for geofencing, which supports covering arbitrary areas vs. confining yourself to specific quadrants.
{% include image.html src="assets/images/system-design/geofence-example.png" alt="geofence-example" caption="" %}
...
{% include image.html src="assets/images/system-design/company-adoptions.png" alt="company-adoptions" caption="" %}
...
{% include image.html src="assets/images/system-design/geohash-table-example.png" alt="geohash-table-example" caption="" %}
...
{% include image.html src="assets/images/system-design/cross-dc-deployment.png" alt="cross-dc-deployment" caption="" %}
