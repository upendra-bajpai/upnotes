---
layout: post
title:  "Chapter28 - digital-wallet"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, digital-wallet,system design]
image: assets/images/system-design/digital-wallet.png
---
# Digital Wallet
...
{% include image.html src="assets/images/system-design/digital-wallet.png" alt="digital-wallet" caption="" %}
...
{% include image.html src="assets/images/system-design/wallet-service.png" alt="wallet-service" caption="" %}
...
{% include image.html src="assets/images/system-design/distributed-transactions-relational-dbs.png" alt="distributed-transactions-relational-dbs" caption="" %}

Here's how the two-phase commit (2PC) protocol works:
{% include image.html src="assets/images/system-design/2pc-protocol.png" alt="2pc-protocol" caption="" %}
...
Phase 1 - try:
{% include image.html src="assets/images/system-design/try-phase.png" alt="try-phase" caption="" %}
...
Phase 2a - confirm:
{% include image.html src="assets/images/system-design/confirm-phase.png" alt="confirm-phase" caption="" %}
...
Phase 2b - cancel:
{% include image.html src="assets/images/system-design/cancel-phase.png" alt="cancel-phase" caption="" %}
...
{% include image.html src="assets/images/system-design/phase-status-tables.png" alt="phase-status-tables" caption="" %}
...
{% include image.html src="assets/images/system-design/unbalanced-state.png" alt="unbalanced-state" caption="" %}
...
{% include image.html src="assets/images/system-design/out-of-order-execution.png" alt="out-of-order-execution" caption="" %}
...
{% include image.html src="assets/images/system-design/saga.png" alt="saga" caption="" %}
...
{% include image.html src="assets/images/system-design/event-sourcing.png" alt="event-sourcing" caption="" %}

Here's a dynamic view of event sourcing:
{% include image.html src="assets/images/system-design/dynamic-event-sourcing.png" alt="dynamic-event-sourcing" caption="" %}

For our wallet service, the commands are balance transfer requests. We can put them in a FIFO queue, such as Kafka:
{% include image.html src="assets/images/system-design/command-queue.png" alt="command-queue" caption="" %}

Here's the full picture:
{% include image.html src="assets/images/system-design/wallet-service-state-macghine.png" alt="wallet-service-state-machine" caption="" %}
...
{% include image.html src="assets/images/system-design/historical-states.png" alt="historical-states" caption="" %}
...
{% include image.html src="assets/images/system-design/cqrs-architecture.png" alt="cqrs-architecture" caption="" %}
...
{% include image.html src="assets/images/system-design/mmap-optimization.png" alt="mmap-optimization" caption="" %}
...
{% include image.html src="assets/images/system-design/rocks-db-approach.png" alt="rocks-db-approach" caption="" %}
...
{% include image.html src="assets/images/system-design/snapshot-approach.png" alt="snapshot-approach" caption="" %}
...
{% include image.html src="assets/images/system-design/raft-replication.png" alt="raft-replication" caption="" %}
...
{% include image.html src="assets/images/system-design/polling-approach.png" alt="polling-approach" caption="" %}
...
{% include image.html src="assets/images/system-design/reverse-proxy.png" alt="reverse-proxy" caption="" %}
...
{% include image.html src="assets/images/system-design/push-state-machines.png" alt="push-state-machines" caption="" %}
...
{% include image.html src="assets/images/system-design/sharded-raft-groups.png" alt="sharded-raft-groups" caption="" %}
