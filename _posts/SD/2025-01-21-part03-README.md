---
layout: post
title:  "Part03 - cruder-app"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, cruder-app,system design]
image: assets/images/system-design/cruder-app.png
---
# Scalability
...
{% include image.html src="assets/images/system-design/cruder-app.png" alt="cruder-app" caption="" %}
...
{% include image.html src="assets/images/system-design/cruder-enhanced.png" alt="cruder-enhanced" caption="" %}
...
{% include image.html src="assets/images/system-design/http-caching-example.png" alt="http-caching-example" caption="" %}
...
{% include image.html src="assets/images/system-design/stale-data-not-modified.png" alt="stale-data-not-modified" caption="" %}
...
{% include image.html src="assets/images/system-design/cdn-example.png" alt="cdn-example" caption="" %}
...
{% include image.html src="assets/images/system-design/partition-example.png" alt="partition-example" caption="" %}
...
{% include image.html src="assets/images/system-design/range-partitioning.png" alt="range-partitioning" caption="" %}
...
{% include image.html src="assets/images/system-design/hash-partitioning.png" alt="hash-partitioning" caption="" %}
...
{% include image.html src="assets/images/system-design/consistent-hashing-rebalancing.png" alt="consistent-hashing-rebalancing" caption="" %}
...
{% include image.html src="assets/images/system-design/as-architecture.png" alt="as-architecture" caption="" %}
...
{% include image.html src="assets/images/system-design/as-partition-layer.png" alt="as-partition-layer" caption="" %}
...
{% include image.html src="assets/images/system-design/as-partition-manager.png" alt="as-partition-manager" caption="" %}
...
{% include image.html src="assets/images/system-design/dns-load-balancing.png" alt="dns-load-balancing" caption="" %}
...
{% include image.html src="assets/images/system-design/network-load-balancer.png" alt="network-load-balancer" caption="" %}
...
{% include image.html src="assets/images/system-design/leader-follower-replication.png" alt="leader-follower-replication" caption="" %}
...
{% include image.html src="assets/images/system-design/dynamodb-table-example-1.png" alt="dynamodb-table-example-1" caption="" %}
...
{% include image.html src="assets/images/system-design/dynamodb-table-example-2.png" alt="dynamodb-table-example-2" caption="" %}
...
{% include image.html src="assets/images/system-design/write-aside.png" alt="write-aside" caption="" %}

Inline cache (aka Write-through) example:
{% include image.html src="assets/images/system-design/write-through-cache.png" alt="write-through-cache" caption="" %}
...
{% include image.html src="assets/images/system-design/write-back-cache.png" alt="write-back-cache" caption="" %}
...
{% include image.html src="assets/images/system-design/local-cache.png" alt="local-cache" caption="" %}
...
{% include image.html src="assets/images/system-design/external-cache.png" alt="external-cache" caption="" %}
...
{% include image.html src="assets/images/system-design/monolithic-app.png" alt="monolithic-app" caption="" %}
...
{% include image.html src="assets/images/system-design/microservices.png" alt="microservices" caption="" %}
...
{% include image.html src="assets/images/system-design/api-gateway.png" alt="api-gateway" caption="" %}
...
{% include image.html src="assets/images/system-design/file-store-as-buffer.png" alt="file-store-as-buffer" caption="" %}
...
{% include image.html src="assets/images/system-design/control-plane-data-plane.png" alt="control-plane-data-plane" caption="" %}
...
{% include image.html src="assets/images/system-design/inbound-outbound-adapters.png" alt="inbound-outbound-adapters" caption="" %}
...
{% include image.html src="assets/images/system-design/one-way-messaging.png" alt="one-way-messaging" caption="" %}
...
{% include image.html src="assets/images/system-design/request-response-messaging.png" alt="request-response-messaging" caption="" %}
...
{% include image.html src="assets/images/system-design/broadcast-messaging.png" alt="broadcast-messaging" caption="" %}
