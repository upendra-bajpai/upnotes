---
layout: post
title:  "Chapter23 - qps-estimation"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, qps-estimation,system design]
image: assets/images/system-design/qps-estimation.png
---
...
{% include image.html src="assets/images/system-design/qps-estimation.png" alt="qps-estimation" caption="" %}
...
{% include image.html src="assets/images/system-design/schema-design.png" alt="schema-design" caption="" %}
...
{% include image.html src="assets/images/system-design/status-state-machine.png" alt="status-state-machine" caption="" %}
...
{% include image.html src="assets/images/system-design/updated-schema.png" alt="updated-schema" caption="" %}
...
{% include image.html src="assets/images/system-design/double-booking-single-user.png" alt="double-booking-single-user" caption="" %}
...
{% include image.html src="assets/images/system-design/idempotency.png" alt="idempotency" caption="" %}
...
{% include image.html src="assets/images/system-design/unique-constraint-violation.png" alt="unique-constraint-violation" caption="" %}

What if there are multiple users making the same reservation?
{% include image.html src="assets/images/system-design/double-booking-multiple-users.png" alt="double-booking-multiple-users" caption="" %}
...
{% include image.html src="assets/images/system-design/pessimistic-locking.png" alt="pessimistic-locking" caption="" %}
...
{% include image.html src="assets/images/system-design/optimistic-locking.png" alt="optimistic-locking" caption="" %}
...
```
{% include image.html src="assets/images/system-design/database-constraint.png" alt="database-constraint" caption="" %}
...
{% include image.html src="assets/images/system-design/inventory-cache.png" alt="inventory-cache" caption="" %}
...
{% include image.html src="assets/images/system-design/microservices-vs-monolith.png" alt="microservices-vs-monolith" caption="" %}
...
{% include image.html src="assets/images/system-design/atomicity-monolith.png" alt="atomicity-monolith" caption="" %}

It's more challenging, however, to guarantee this atomicity when the operation spans across multiple services:
{% include image.html src="assets/images/system-design/microservice-non-atomic-operation.png" alt="microservice-non-atomic-operation" caption="" %}
