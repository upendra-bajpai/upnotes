---
layout: post
title:  "Chapter07 - cap-theorem"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, cap-theorem,system design]
image: assets/images/system-design/cap-theorem.png
---
...
{% include image.html src="assets/images/system-design/cap-theorem.png" alt="cap-theorem" caption="" %}
...
{% include image.html src="assets/images/system-design/example-distributed-system.png" alt="example-distributed-system" caption="" %}

In the real world, a network partition can occur which hinders communication with eg node 3:
{% include image.html src="assets/images/system-design/network-partition-example.png" alt="network-partition-example" caption="" %}
...
{% include image.html src="assets/images/system-design/consistent-hashing.png" alt="consistent-hashing" caption="" %}
...
{% include image.html src="assets/images/system-design/data-replication.png" alt="data-replication" caption="" %}
...
{% include image.html src="assets/images/system-design/write-quorum-example.png" alt="write-quorum-example" caption="" %}
...
{% include image.html src="assets/images/system-design/inconsistency-example.png" alt="inconsistency-example" caption="" %}
...
{% include image.html src="assets/images/system-design/inconsistency-resolution.png" alt="inconsistency-resolution" caption="" %}
...
{% include image.html src="assets/images/system-design/multicasting.png" alt="multicasting" caption="" %}
...
{% include image.html src="assets/images/system-design/gossip-protocol.png" alt="gossip-protocol" caption="" %}
...
{% include image.html src="assets/images/system-design/merkle-tree.png" alt="merkle-tree" caption="" %}
...
{% include image.html src="assets/images/system-design/architecture-diagram.png" alt="architecture-diagram" caption="" %}
...
{% include image.html src="assets/images/system-design/node-responsibilities.png" alt="node-responsibilities" caption="" %}

## Write path
{% include image.html src="assets/images/system-design/write-pth.png" alt="write-path" caption="" %}
...
{% include image.html src="assets/images/system-design/read-path-in-memory.png" alt="read-path-in-memory" caption="" %}

Read path when data is not in memory:
{% include image.html src="assets/images/system-design/read-path-not-in-memory.png" alt="read-path-not-in-memory" caption="" %}
