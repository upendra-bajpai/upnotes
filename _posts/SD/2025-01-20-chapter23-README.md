...
![qps-estimation](/assets/images/system-design/qps-estimation.png)
...
![schema-design](/assets/images/system-design/schema-design.png)
...
![status-state-machine](/assets/images/system-design/status-state-machine.png)
...
![updated-schema](/assets/images/system-design/updated-schema.png)
...
![double-booking-single-user](/assets/images/system-design/double-booking-single-user.png)
...
![idempotency](/assets/images/system-design/idempotency.png)
...
![unique-constraint-violation](/assets/images/system-design/unique-constraint-violation.png)

What if there are multiple users making the same reservation?
![double-booking-multiple-users](/assets/images/system-design/double-booking-multiple-users.png)
...
![pessimistic-locking](/assets/images/system-design/pessimistic-locking.png)
...
![optimistic-locking](/assets/images/system-design/optimistic-locking.png)
...
```
![database-constraint](/assets/images/system-design/database-constraint.png)
...
![inventory-cache](/assets/images/system-design/inventory-cache.png)
...
![microservices-vs-monolith](/assets/images/system-design/microservices-vs-monolith.png)
...
![atomicity-monolith](/assets/images/system-design/atomicity-monolith.png)

It's more challenging, however, to guarantee this atomicity when the operation spans across multiple services:
![microservice-non-atomic-operation](/assets/images/system-design/microservice-non-atomic-operation.png)
