---
layout: post
title:  "Chapter24 - dns-lookup"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, dns-lookup,system design]
image: assets/images/system-design/dns-lookup.png
---
...
{% include image.html src="assets/images/system-design/dns-lookup.png" alt="dns-lookup" caption="" %}
...
{% include image.html src="assets/images/system-design/traditional-mail-server.png" alt="traditional-mail-server" caption="" %}
...
{% include image.html src="assets/images/system-design/local-dir-storage.png" alt="local-dir-storage" caption="" %}
...
{% include image.html src="assets/images/system-design/email-sending-flow.png" alt="email-sending-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/email-receiving-flkow.png" alt="email-receiving-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/legend.png" alt="legend" caption="" %}

Here is the folders table:
{% include image.html src="assets/images/system-design/folders-table.png" alt="folders-table" caption="" %}

emails table:
{% include image.html src="assets/images/system-design/emails-table.png" alt="emails-table" caption="" %}
...
{% include image.html src="assets/images/system-design/attachments.png" alt="attachments" caption="" %}
...
{% include image.html src="assets/images/system-design/read-unread-emails.png" alt="read-unread-emails" caption="" %}
...
{% include image.html src="assets/images/system-design/elasticsearch.png" alt="elasticsearch" caption="" %}
...
{% include image.html src="assets/images/system-design/lsm-tree.png" alt="lsm-tree" caption="" %}
...
{% include image.html src="assets/images/system-design/multi-dc-example.png" alt="multi-dc-example" caption="" %}
