...
![network-protocols](/assets/images/system-design/network-protocols.png)
...
![tcp-handshake](/assets/images/system-design/tcp-handshake.png)
...
![tcp-receive-buffer](/assets/images/system-design/tcp-receive-buffer.png)

The receive buffer size is also communicated back to the sender, who uses it to determine when to back-off:
![ack-receive-buffer-size](/assets/images/system-design/ack-receive-buffer-size.png)
...
![congestion-window](/assets/images/system-design/congestion-window.png)
...
![certificate-chain](/assets/images/system-design/certificate-chain.png)
...
![dns-resolution-process](/assets/images/system-design/dns-resolution-process.png)
...
![http-request-response-example](/assets/images/system-design/http-request-response-example.png)
