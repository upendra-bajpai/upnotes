---
layout: post
title:  "Chapter20 - message-queue-components"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, message-queue-components,system design]
image: assets/images/system-design/message-queue-components.png
---
...
{% include image.html src="assets/images/system-design/message-queue-components.png" alt="message-queue-components" caption="" %}
...
{% include image.html src="assets/images/system-design/point-to-point-model.png" alt="point-to-point-model" caption="" %}
...
{% include image.html src="assets/images/system-design/publish-subscribe-model.png" alt="publish-subscribe-model" caption="" %}
...
{% include image.html src="assets/images/system-design/partitions.png" alt="partitions" caption="" %}
...
{% include image.html src="assets/images/system-design/consumer-groups.png" alt="consumer-groups" caption="" %}
...
{% include image.html src="assets/images/system-design/wal-example.png" alt="wal-example" caption="" %}
...
{% include image.html src="assets/images/system-design/message-structure.png" alt="message-structure" caption="" %}
...
{% include image.html src="assets/images/system-design/routing-layer.png" alt="routing-layer" caption="" %}
...
{% include image.html src="assets/images/system-design/routing-layer-producer.png" alt="routing-layer-producer" caption="" %}
...
{% include image.html src="assets/images/system-design/batch-size-throughput-vs-latency.png" alt="batch-size-throughput-vs-latency" caption="" %}
...
{% include image.html src="assets/images/system-design/consumer-example.png" alt="consumer-example" caption="" %}
...
{% include image.html src="assets/images/system-design/consumer-flow.png" alt="consumer-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/consumer-rebalancing.png" alt="consumer-rebalancing" caption="" %}
...
{% include image.html src="assets/images/system-design/consumer-rebalance-example.png" alt="consumer-rebalance-example" caption="" %}

Let's explore what happens when a consumer joins a group:
{% include image.html src="assets/images/system-design/consumer-join-group-usecase.png" alt="consumer-join-group-usecase" caption="" %}
...
{% include image.html src="assets/images/system-design/consumer-leaves-group-usecase.png" alt="consumer-leaves-group-usecase" caption="" %}
...
{% include image.html src="assets/images/system-design/consumer-no-heartbeat-usecase.png" alt="consumer-no-heartbeat-usecase" caption="" %}

## State storage
The state storage stores mapping between partitions and consumers, as well as the last consumed offsets for a partition.
{% include image.html src="assets/images/system-design/state-storage.png" alt="state-storage" caption="" %}
...
{% include image.html src="assets/images/system-design/zookeeper.png" alt="zookeeper" caption="" %}
...
{% include image.html src="assets/images/system-design/replication-example.png" alt="replication-example" caption="" %}
...
{% include image.html src="assets/images/system-design/in-sync-replicas-example.png" alt="in-sync-replicas-example" caption="" %}
...
{% include image.html src="assets/images/system-design/ack-all.png" alt="ack-all" caption="" %}
...
{% include image.html src="assets/images/system-design/ack-1.png" alt="ack-1" caption="" %}
...
{% include image.html src="assets/images/system-design/ack-0.png" alt="ack-0" caption="" %}
...
{% include image.html src="assets/images/system-design/broker-failure-recovery.png" alt="broker-failure-recovery" caption="" %}
...
{% include image.html src="assets/images/system-design/broker-replica-redistribution.png" alt="broker-replica-redistribution" caption="" %}
...
{% include image.html src="assets/images/system-design/partition-exmaple.png" alt="partition-exmaple" caption="" %}

Decreasing the number of partitions is more involved:
{% include image.html src="assets/images/system-design/partition-decrease.png" alt="partition-decrease" caption="" %}
...
{% include image.html src="assets/images/system-design/at-most-once.png" alt="at-most-once" caption="" %}
...
{% include image.html src="assets/images/system-design/at-least-once.png" alt="at-least-once" caption="" %}
...
{% include image.html src="assets/images/system-design/exactly-once.png" alt="exactly-once" caption="" %}
...
{% include image.html src="assets/images/system-design/message-filtering.png" alt="message-filtering" caption="" %}
...
{% include image.html src="assets/images/system-design/delayed-message-implementation.png" alt="delayed-message-implementation" caption="" %}
