---
layout: post
title:  "Chapter14 - google-search"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, google-search,system design]
image: assets/images/system-design/google-search.png
---
...
{% include image.html src="assets/images/system-design/google-search.png" alt="google-search" caption="" %}
...
{% include image.html src="assets/images/system-design/frequency-table.png" alt="frequency-table" caption="" %}
...
{% include image.html src="assets/images/system-design/query-service-example.png" alt="query-service-example" caption="" %}

Querying the data set is a matter of running the following SQL query:
{% include image.html src="assets/images/system-design/query-service-sql-query.png" alt="query-service-sql-query" caption="" %}
...
{% include image.html src="assets/images/system-design/trie-example-with-frequency.png" alt="trie-example-with-frequency" caption="" %}
...
{% include image.html src="assets/images/system-design/trie-algorithm.png" alt="trie-algorithm" caption="" %}
...
{% include image.html src="assets/images/system-design/caching-top-search-results.png" alt="caching-top-search-results" caption="" %}
...
{% include image.html src="assets/images/system-design/data-gathering-service.png" alt="data-gathering-service" caption="" %}

The analytics logs contain raw rows of data related to search terms \w timestamps:
{% include image.html src="assets/images/system-design/analytics-log.png" alt="analytics-log" caption="" %}
...
{% include image.html src="assets/images/system-design/weekly-aggredated-data.png" alt="weekly-aggredated-data" caption="" %}
...
{% include image.html src="assets/images/system-design/trie-as-hashmap.png" alt="trie-as-hashmap" caption="" %}

## Query service
The query service fetches top suggestions from Trie Cache or fallbacks to Trie DB on cache miss:
{% include image.html src="assets/images/system-design/query-service-improved.png" alt="query-service-improved" caption="" %}
...
{% include image.html src="assets/images/system-design/google-browser-caching.png" alt="google-browser-caching" caption="" %}
...
{% include image.html src="assets/images/system-design/update-trie.png" alt="update-trie" caption="" %}
...
{% include image.html src="assets/images/system-design/filter-layer.png" alt="filter-layer" caption="" %}
...
{% include image.html src="assets/images/system-design/sharding.png" alt="sharding" caption="" %}
