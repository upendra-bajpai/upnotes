---
layout: post
title:  "Chapter10 - web-crawler-example"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, web-crawler-example,system design]
image: assets/images/system-design/web-crawler-example.png
---
...
{% include image.html src="assets/images/system-design/web-crawler-example.png" alt="web-crawler-example" caption="" %}
...
{% include image.html src="assets/images/system-design/web-crawler-workflow.png" alt="web-crawler-workflow" caption="" %}
...
{% include image.html src="assets/images/system-design/download-queue.png" alt="download-queue" caption="" %}
 * The queue router ensures that each queue contains URLs from the same host.
 * Mapping table - maps each host to a queue.
{% include image.html src="assets/images/system-design/mapping-table.png" alt="mapping-table" caption="" %}
...
{% include image.html src="assets/images/system-design/prioritizer.png" alt="prioritizer" caption="" %}
...
{% include image.html src="assets/images/system-design/distributed-crawl.png" alt="distributed-crawl" caption="" %}
...
{% include image.html src="assets/images/system-design/extendable-crawler.png" alt="extendable-crawler" caption="" %}
