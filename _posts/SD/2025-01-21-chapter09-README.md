---
layout: post
title:  "Chapter09 - tinyurl-example"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, tinyurl-example,system design]
image: assets/images/system-design/tinyurl-example.png
---
...
## URL Redirecting
How it works:
{% include image.html src="assets/images/system-design/tinyurl-example.png" alt="tinyurl-example" caption="" %}
...
{% include image.html src="assets/images/system-design/url-table.png" alt="url-table" caption="" %}
...
{% include image.html src="assets/images/system-design/hash-collision-mechanism.png" alt="hash-collision-mechanism" caption="" %}
...
{% include image.html src="assets/images/system-design/url-shortening-deep-dive.png" alt="url-shortening-deep-dive" caption="" %}
...
{% include image.html src="assets/images/system-design/url-redirection-deep-dive.png" alt="url-redirection-deep-dive" caption="" %}
