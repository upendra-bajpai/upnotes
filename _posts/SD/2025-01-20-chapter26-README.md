...
![leaderboard](/assets/images/system-design/leaderboard.png)
...
![message-queue-based-comm](/assets/images/system-design/message-queue-based-comm.png)
...
![leaderboard-table](/assets/images/system-design/leaderboard-table.png)
...
![user-wins-point](/assets/images/system-design/user-wins-point.png)
...
![find-leaderboard-position](/assets/images/system-design/find-leaderboard-position.png)
...
![sorted-set](/assets/images/system-design/sorted-set.png)
...
![skip-list](/assets/images/system-design/skip-list.png)
...
![skip-list-performance](/assets/images/system-design/skip-list-performance.png)
...
![leaderboard-position-of-user](/assets/images/system-design/leaderboard-position-of-user.png)
...
![manage-services-ourselves](/assets/images/system-design/manage-services-ourselves.png)
...
![api-gateway-mapping](/assets/images/system-design/api-gateway-mapping.png)
...
![user-scoring-point-lambda](/assets/images/system-design/user-scoring-point-lambda.png)

Example user retrieving leaderboard:
![user-retrieve-leaderboard](/assets/images/system-design/user-retrieve-leaderboard.png)
...
![range-partition](/assets/images/system-design/range-partition.png)
...
![hash-partition](/assets/images/system-design/hash-partition.png)
...
![top-10-players-calculation](/assets/images/system-design/top-10-players-calculation.png)
...
![dynamo-db](/assets/images/system-design/dynamo-db.png)

Let's start from a table for storing a leaderboard for a chess game:
![chess-game-leaderboard-table-1](/assets/images/system-design/chess-game-leaderboard-table-1.png)

This works well, but doesn't scale well if we need to query anything by score. Hence, we can put the score as a sort key:
![chess-game-leaderboard-table-2](/assets/images/system-design/chess-game-leaderboard-table-2.png)
...
![chess-game-leaderboard-table-3](/assets/images/system-design/chess-game-leaderboard-table-3.png)
...
![scatter-gather-2](/assets/images/system-design/scatter-gather-2.png)
