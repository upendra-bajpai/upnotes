---
layout: post
title:  "Part02 - failure-detection"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, failure-detection,system design]
image: assets/images/system-design/failure-detection.png
---
# Coordination
...
{% include image.html src="assets/images/system-design/failure-detection.png" alt="failure-detection" caption="" %}
...
{% include image.html src="assets/images/system-design/lamport-clock.png" alt="lamport-clock" caption="" %}
...
{% include image.html src="assets/images/system-design/vector-clock.png" alt="vector-clock" caption="" %}
...
{% include image.html src="assets/images/system-design/raft-state-machine.png" alt="raft-state-machine" caption="" %}
...
{% include image.html src="assets/images/system-design/event-log-raft.png" alt="event-log-raft" caption="" %}
...
{% include image.html src="assets/images/system-design/instant-write.png" alt="instant-write" caption="" %}

In reality, writes take some time:
{% include image.html src="assets/images/system-design/non-instant-write.png" alt="non-instant-write" caption="" %}
...
{% include image.html src="assets/images/system-design/strong-consistency.png" alt="strong-consistency" caption="" %}
...
{% include image.html src="assets/images/system-design/sequential-consistency.png" alt="sequential-consistency" caption="" %}
...
{% include image.html src="assets/images/system-design/chain-replication.png" alt="chain-replication" caption="" %}
...
{% include image.html src="assets/images/system-design/dirty-read-chain-replication.png" alt="dirty-read-chain-replication" caption="" %}
...
{% include image.html src="assets/images/system-design/best-effort-broadcast.png" alt="best-effort-broadcast" caption="" %}
...
{% include image.html src="assets/images/system-design/eager-reliable-broadcast.png" alt="eager-reliable-broadcast" caption="" %}
...
{% include image.html src="assets/images/system-design/gossip-broadcast.png" alt="gossip-broadcast" caption="" %}
...
{% include image.html src="assets/images/system-design/divergence.png" alt="divergence" caption="" %}
...
{% include image.html src="assets/images/system-design/semilattice.png" alt="semilattice" caption="" %}
...
{% include image.html src="assets/images/system-design/lww-register.png" alt="lww-register" caption="" %}
...
{% include image.html src="assets/images/system-design/mv-register.png" alt="mv-register" caption="" %}
...
{% include image.html src="assets/images/system-design/w-r-greater-than-n.png" alt="w-r-greater-than-n" caption="" %}
...
{% include image.html src="assets/images/system-design/cops-example.png" alt="cops-example" caption="" %}
...
{% include image.html src="assets/images/system-design/tx-isolation-levels.png" alt="tx-isolation-levels" caption="" %}
...
{% include image.html src="assets/images/system-design/2pc-example.png" alt="2pc-example" caption="" %}
...
{% include image.html src="assets/images/system-design/spanner-example.png" alt="spanner-example" caption="" %}
...
{% include image.html src="assets/images/system-design/travel-booking-saga.png" alt="travel-booking-saga" caption="" %}
