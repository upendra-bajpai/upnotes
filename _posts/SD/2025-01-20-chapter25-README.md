...
![storage-comparison](/assets/images/system-design/storage-comparison.png)
...
![object-store-vs-unix](/assets/images/system-design/object-store-vs-unix.png)

By separating metadata from file contents, we can scale the different stores independently:
![bucket-and-object](/assets/images/system-design/bucket-and-object.png)

## High-level design
![high-level-design](/assets/images/system-design/high-level-design.png)
...
## Uploading an object
![uploading-object](/assets/images/system-design/uploading-object.png)
...
![download-object](/assets/images/system-design/download-object.png)
...
![data-store-interactions](/assets/images/system-design/data-store-interactions.png)

The data store's main components:
![data-store-main-components](/assets/images/system-design/data-store-main-components.png)
...
![virtual-cluster-map](/assets/images/system-design/virtual-cluster-map.png)
...
![data-persistence-flow](/assets/images/system-design/data-persistence-flow.png)
...
![consistency-vs-latency](/assets/images/system-design/consistency-vs-latency.png)
...
![wal-optimization](/assets/images/system-design/wal-optimization.png)
...
![updated-data-persistence-flow](/assets/images/system-design/updated-data-persistence-flow.png)
...
![failure-domain-isolation](/assets/images/system-design/failure-domain-isolation.png)
...
![erasure-coding](/assets/images/system-design/erasure-coding.png)
...
![erasure-coding-across-failure-domains](/assets/images/system-design/erasure-coding-across-failure-domains.png)
...
![erasure-coding-vs-replication](/assets/images/system-design/erasure-coding-vs-replication.png)
...
![checksums-for-correctness](/assets/images/system-design/checksums-for-correctness.png)
...
## Metadata data model
Table schemas:
![metadata-data-model](/assets/images/system-design/metadata-data-model.png)
...
![object-versioning](/assets/images/system-design/object-versioning.png)
...
![deleting-versioned-object](/assets/images/system-design/deleting-versioned-object.png)
...
![multipart-upload](/assets/images/system-design/multipart-upload.png)
...
![compaction](/assets/images/system-design/compaction.png)
