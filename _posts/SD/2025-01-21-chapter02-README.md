---
layout: post
title:  "Chapter02 - single-server-setup"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, single-server-setup,system design]
image: assets/images/system-design/single-server-setup.png
---
...
{% include image.html src="assets/images/system-design/single-server-setup.png" alt="single-server-setup" caption="" %}
...
{% include image.html src="assets/images/system-design/database-separate-from-web.png" alt="database-separate-from-web" caption="" %}
...
{% include image.html src="assets/images/system-design/load-balancer-example.png" alt="load-balancer-example" caption="" %}
...
{% include image.html src="assets/images/system-design/master-slave-replication.png" alt="master-slave-replication" caption="" %}
...
{% include image.html src="assets/images/system-design/master-slave-db-replication.png" alt="master-slave-db-replication" caption="" %}
...
{% include image.html src="assets/images/system-design/cache-tier.png" alt="cache-tier" caption="" %}
...
{% include image.html src="assets/images/system-design/cdn.png" alt="cdn" caption="" %}

Here's the request flow:
{% include image.html src="assets/images/system-design/cdn-request-flow.png" alt="cdn-request-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/web-app-design-after-cdn.png" alt="web-app-design-after-cdn" caption="" %}
...
{% include image.html src="assets/images/system-design/stateful-servers.png" alt="stateful-servers" caption="" %}
...
{% include image.html src="assets/images/system-design/stateless-architecture.png" alt="stateless-architecture" caption="" %}
...
{% include image.html src="assets/images/system-design/web-app-architecture-updated.png" alt="web-app-architecture-updated" caption="" %}
...
# Data centers
{% include image.html src="assets/images/system-design/data-centers.png" alt="data-centers" caption="" %}
...
{% include image.html src="assets/images/system-design/data-center-failover.png" alt="data-center-failover" caption="" %}
...
{% include image.html src="assets/images/system-design/message-queue.png" alt="message-queue" caption="" %}
...
{% include image.html src="assets/images/system-design/photo-processing-queue.png" alt="photo-processing-queue" caption="" %}
...
{% include image.html src="assets/images/system-design/sys-design-after-monitoring.png" alt="sys-design-after-monitoring" caption="" %}
...
{% include image.html src="assets/images/system-design/vertical-vs-horizontal-scaling.png" alt="vertical-vs-horizontal-scaling" caption="" %}
...
{% include image.html src="assets/images/system-design/database-sharding.png" alt="database-sharding" caption="" %}

Here's how the user data looks like in this example:
{% include image.html src="assets/images/system-design/user-data-in-shards.png" alt="user-data-in-shards" caption="" %}
...
{% include image.html src="assets/images/system-design/updated-system-design.png" alt="updated-system-design" caption="" %}
