...
![digital-advertising-example](/assets/images/system-design/digital-advertising-example.png)
...
![high-level-design-1](/assets/images/system-design/high-level-design-1.png)
...
![high-level-design-2](/assets/images/system-design/high-level-design-2.png)
...
![atomic-commit](/assets/images/system-design/atomic-commit.png)

For the aggregation service, using the MapReduce framework is a good option:
![ad-count-map-reduce](/assets/images/system-design/ad-count-map-reduce.png)
![top-100-map-reduce](/assets/images/system-design/top-100-map-reduce.png)
...
![map-node](/assets/images/system-design/map-node.png)
...
![reduce-node](/assets/images/system-design/reduce-node.png)
...
![use-case-1](/assets/images/system-design/use-case-1.png)
 * Ads are partitioned using `ad_id % 3`

**Use-case 2 - return top N most clicked ads**:
![use-case-2](/assets/images/system-design/use-case-2.png)
...
Lambda architecture:
![lambda-architecture](/assets/images/system-design/lambda-architecture.png)

Kappa architecture:
![kappa-architecture](/assets/images/system-design/kappa-architecture.png)
...
![recalculation-example](/assets/images/system-design/recalculation-example.png)
...
![watermark-technique](/assets/images/system-design/watermark-technique.png)
...
![watermark-2](/assets/images/system-design/watermark-2.png)
...
![tumbling-window](/assets/images/system-design/tumbling-window.png)

As well as a sliding window for the top N clicked ads in M minutes aggregation:
![sliding-window](/assets/images/system-design/sliding-window.png)
...
![data-duplication-example](/assets/images/system-design/data-duplication-example.png)
...
![data-duplication-example-2](/assets/images/system-design/data-duplication-example-2.png)
...
![data-duplication-example-3](/assets/images/system-design/data-duplication-example-3.png)
...
![scale-consumers](/assets/images/system-design/scale-consumers.png)

How do we scale the aggregation service:
![aggregation-service-scaling](/assets/images/system-design/aggregation-service-scaling.png)
...
![multi-threading-example](/assets/images/system-design/multi-threading-example.png)
...
![cassandra-scalability](/assets/images/system-design/cassandra-scalability.png)
...
![hotspot-issue](/assets/images/system-design/hotspot-issue.png)
...
![fault-tolerance-example](/assets/images/system-design/fault-tolerance-example.png)
...
![fault-tolerance-recovery-example](/assets/images/system-design/fault-tolerance-recovery-example.png)
...
![reconciliation-flow](/assets/images/system-design/reconciliation-flow.png)
...
![alternative-design](/assets/images/system-design/alternative-design.png)
