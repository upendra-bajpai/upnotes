...
![web-crawler-example](/assets/images/system-design/web-crawler-example.png)
...
![web-crawler-workflow](/assets/images/system-design/web-crawler-workflow.png)
...
![download-queue](/assets/images/system-design/download-queue.png)
 * The queue router ensures that each queue contains URLs from the same host.
 * Mapping table - maps each host to a queue.
![mapping-table](/assets/images/system-design/mapping-table.png)
...
![prioritizer](/assets/images/system-design/prioritizer.png)
...
![distributed-crawl](/assets/images/system-design/distributed-crawl.png)
...
![extendable-crawler](/assets/images/system-design/extendable-crawler.png)
