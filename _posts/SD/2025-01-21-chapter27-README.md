---
layout: post
title:  "Chapter27 - high-level-flow"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, high-level-flow,system design]
image: assets/images/system-design/high-level-flow.png
---
# Payment System
...
{% include image.html src="assets/images/system-design/high-level-flow.png" alt="high-level-flow" caption="" %}

## Pay-in flow
Here's the high-level overview of the pay-in flow:
{% include image.html src="assets/images/system-design/payin-flow-high-level.png" alt="pay-in-flow-high-level" caption="" %}
...
{% include image.html src="assets/images/system-design/hosted-payment-page.png" alt="hosted-payment-page" caption="" %}
...
{% include image.html src="assets/images/system-design/hosted-payment-page-workflow.png" alt="hosted-payment-page-workflow" caption="" %}
...
{% include image.html src="assets/images/system-design/settlement-report.png" alt="settlement-report" caption="" %}
...
{% include image.html src="assets/images/system-design/single-receiver.png" alt="single-receiver" caption="" %}

Multiple receivers - multiple receivers subscribe to the same topic, but messages are forwarded to all of them:
{% include image.html src="assets/images/system-design/multiple-receiver.png" alt="multiple-receiver" caption="" %}
...
{% include image.html src="assets/images/system-design/failed-payments.png" alt="failed-payments" caption="" %}
...
{% include image.html src="assets/images/system-design/retry-mechanism.png" alt="retry-mechanism" caption="" %}
...
{% include image.html src="assets/images/system-design/idempotency-example.png" alt="idempotency-example" caption="" %}
