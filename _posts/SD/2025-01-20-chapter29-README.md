...
![world-stock-exchanges](/assets/images/system-design/world-stock-exchanges.png)
...
![l1-price](/assets/images/system-design/l1-price.png)

L2 includes more price levels:
![l2-price](/assets/images/system-design/l2-price.png)

L3 shows levels and queued quantity at each level:
![l3-price](/assets/images/system-design/l3-price.png)

A candlestick shows the market open and close price, as well as the highest and lowest prices in the given interval:
![candlestick](/assets/images/system-design/candlestick.png)
...
![sequencer](/assets/images/system-design/sequencer.png)
...
![client-gateway](/assets/images/system-design/client-gateway.png)
...
![client-gateways](/assets/images/system-design/client-gateways.png)
...
![market-data](/assets/images/system-design/market-data.png)

### Reporting flow
The reporter is not on the critical path, but it is an important component nevertheless.
![reporting-flow](/assets/images/system-design/reporting-flow.png)
...
![product-order-execution-data-model](/assets/images/system-design/product-order-execution-data-model.png)
...
![order-book-execution](/assets/images/system-design/order-book-execution.png)
...
![order-book-impl](/assets/images/system-design/order-book-impl.png)
...
![mmap-bus](/assets/images/system-design/mmap-bus.png)
...
![application-loop](/assets/images/system-design/application-loop.png)
...
![design-so-far](/assets/images/system-design/design-so-far.png)
...
![sequencer-deep-dive](/assets/images/system-design/sequencer-deep-dive.png)
...
![leader-election](/assets/images/system-design/leader-election.png)
...
![replication-across-servers](/assets/images/system-design/replication-across-servers.png)

Example leader-election terms:
![leader-election-terms](/assets/images/system-design/leader-election-terms.png)
...
![determinism](/assets/images/system-design/determinism.png)
...
![market-data-publisher](/assets/images/system-design/market-data-publisher.png)
