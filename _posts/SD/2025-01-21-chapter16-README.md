---
layout: post
title:  "Chapter16 - storage-example"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, storage-example,system design]
image: assets/images/system-design/storage-example.png
---
# Design Google Drive
...
{% include image.html src="assets/images/system-design/storage-example.png" alt="storage-example" caption="" %}
...
{% include image.html src="assets/images/system-design/sharding-example.png" alt="sharding-example" caption="" %}
...
{% include image.html src="assets/images/system-design/amazon-s3.png" alt="amazon-s3" caption="" %}
...
{% include image.html src="assets/images/system-design/updated-simple-design.png" alt="updated-simple-design" caption="" %}
...
{% include image.html src="assets/images/system-design/sync-conflict.png" alt="sync-conflict" caption="" %}
...
{% include image.html src="assets/images/system-design/sync-conflict-example.png" alt="sync-conflict-example" caption="" %}
...
{% include image.html src="assets/images/system-design/block-servers-deep-dive.png" alt="block-servers-deep-dive" caption="" %}

Example delta sync:
{% include image.html src="assets/images/system-design/delta-sync.png" alt="delta-sync" caption="" %}
...
{% include image.html src="assets/images/system-design/metadata-db-deep-dive.png" alt="metadata-db-deep-dive" caption="" %}
...
## Upload flow
{% include image.html src="assets/images/system-design/upload-flow.png" alt="upload-flow" caption="" %}
...
{% include image.html src="assets/images/system-design/download-flow.png" alt="download-flow" caption="" %}
