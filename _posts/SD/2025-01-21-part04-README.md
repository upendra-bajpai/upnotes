---
layout: post
title:  "Part04 - cascade-failure-1"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, cascade-failure-1,system design]
image: assets/images/system-design/cascade-failure-1.png
---
# Resiliency
...
{% include image.html src="assets/images/system-design/cascade-failure-1.png" alt="cascading failure 1" caption="" %}
...
{% include image.html src="assets/images/system-design/risk-matrix.png" alt="risk-matrix" caption="" %}
...
{% include image.html src="assets/images/system-design/dc-replication.png" alt="dc-replication" caption="" %} 
...
{% include image.html src="assets/images/system-design/partitioning.png" alt="partitioning" caption="" %}
...
{% include image.html src="assets/images/system-design/shuffle-sharding.png" alt="shuffle-sharding" caption="" %}
...
{% include image.html src="assets/images/system-design/azure-storage-cellular-architecture.png" alt="azure-storage-cellular-architecture" caption="" %}
...
{% include image.html src="assets/images/system-design/retry-storm.png" alt="retry-storm" caption="" %}
...
{% include image.html src="assets/images/system-design/retry-amplification.png" alt="retry-amplification" caption="" %}
...
Here's how it works:
{% include image.html src="assets/images/system-design/circuit-breaker.png" alt="circuit-breaker" caption="" %}
...
{% include image.html src="assets/images/system-design/load-leveling.png" alt="load-leveling" caption="" %}
...
{% include image.html src="assets/images/system-design/epochs-1m.png" alt="epochs-1m" caption="" %}
...
{% include image.html src="assets/images/system-design/incrementing-bucket-counter.png" alt="incrementing-bucket-counter" caption="" %}
...
{% include image.html src="assets/images/system-design/batch-update.png" alt="batch-update" caption="" %}
