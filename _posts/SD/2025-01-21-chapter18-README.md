---
layout: post
title:  "Chapter18 - fan-out-backend"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, fan-out-backend,system design]
image: assets/images/system-design/fan-out-backend.png
---
# Nearby Friends
...
{% include image.html src="assets/images/system-design/fan-out-backend.png" alt="fan-out-backend" caption="" %}
...
{% include image.html src="assets/images/system-design/simple-high-level-design.png" alt="simple-high-level-design" caption="" %}
...
{% include image.html src="assets/images/system-design/redis-pubsub-usage.png" alt="redis-pubsub-usage" caption="" %}
...
{% include image.html src="assets/images/system-design/periodic-location-update.png" alt="periodic-location-update" caption="" %}
...
{% include image.html src="assets/images/system-design/detailed-periodic-location-update.png" alt="detailed-periodic-location-update" caption="" %}
...
{% include image.html src="assets/images/system-design/channel-distribution-data.png" alt="channel-distribution-data" caption="" %}
...
{% include image.html src="assets/images/system-design/geohash-pubsub.png" alt="geohash-pubsub" caption="" %}

Anyone within the geohash subscribes to the appropriate channel to receive location updates for random users:
{% include image.html src="assets/images/system-design/location-updates-geohash.png" alt="location-updates-geohash" caption="" %}

We could also subscribe to several geohashes to handle cases where someone is close but in a bordering geohash:
{% include image.html src="assets/images/system-design/geohash-borders.png" alt="geohash-borders" caption="" %}
