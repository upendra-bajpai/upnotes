---
layout: post
title:  "Chapter22 - digital-advertising-example"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, digital-advertising-example,system design]
image: assets/images/system-design/digital-advertising-example.png
---
...
{% include image.html src="assets/images/system-design/digital-advertising-example.png" alt="digital-advertising-example" caption="" %}
...
{% include image.html src="assets/images/system-design/high-level-design-1.png" alt="high-level-design-1" caption="" %}
...
{% include image.html src="assets/images/system-design/high-level-design-2.png" alt="high-level-design-2" caption="" %}
...
{% include image.html src="assets/images/system-design/atomic-commit.png" alt="atomic-commit" caption="" %}

For the aggregation service, using the MapReduce framework is a good option:
{% include image.html src="assets/images/system-design/ad-count-map-reduce.png" alt="ad-count-map-reduce" caption="" %}
{% include image.html src="assets/images/system-design/top-100-map-reduce.png" alt="top-100-map-reduce" caption="" %}
...
{% include image.html src="assets/images/system-design/map-node.png" alt="map-node" caption="" %}
...
{% include image.html src="assets/images/system-design/reduce-node.png" alt="reduce-node" caption="" %}
...
{% include image.html src="assets/images/system-design/use-case-1.png" alt="use-case-1" caption="" %}
 * Ads are partitioned using `ad_id % 3`

**Use-case 2 - return top N most clicked ads**:
{% include image.html src="assets/images/system-design/use-case-2.png" alt="use-case-2" caption="" %}
...
Lambda architecture:
{% include image.html src="assets/images/system-design/lambda-architecture.png" alt="lambda-architecture" caption="" %}

Kappa architecture:
{% include image.html src="assets/images/system-design/kappa-architecture.png" alt="kappa-architecture" caption="" %}
...
{% include image.html src="assets/images/system-design/recalculation-example.png" alt="recalculation-example" caption="" %}
...
{% include image.html src="assets/images/system-design/watermark-technique.png" alt="watermark-technique" caption="" %}
...
{% include image.html src="assets/images/system-design/watermark-2.png" alt="watermark-2" caption="" %}
...
{% include image.html src="assets/images/system-design/tumbling-window.png" alt="tumbling-window" caption="" %}

As well as a sliding window for the top N clicked ads in M minutes aggregation:
{% include image.html src="assets/images/system-design/sliding-window.png" alt="sliding-window" caption="" %}
...
{% include image.html src="assets/images/system-design/data-duplication-example.png" alt="data-duplication-example" caption="" %}
...
{% include image.html src="assets/images/system-design/data-duplication-example-2.png" alt="data-duplication-example-2" caption="" %}
...
{% include image.html src="assets/images/system-design/data-duplication-example-3.png" alt="data-duplication-example-3" caption="" %}
...
{% include image.html src="assets/images/system-design/scale-consumers.png" alt="scale-consumers" caption="" %}

How do we scale the aggregation service:
{% include image.html src="assets/images/system-design/aggregation-service-scaling.png" alt="aggregation-service-scaling" caption="" %}
...
{% include image.html src="assets/images/system-design/multi-threading-example.png" alt="multi-threading-example" caption="" %}
...
{% include image.html src="assets/images/system-design/cassandra-scalability.png" alt="cassandra-scalability" caption="" %}
...
{% include image.html src="assets/images/system-design/hotspot-issue.png" alt="hotspot-issue" caption="" %}
...
{% include image.html src="assets/images/system-design/fault-tolerance-example.png" alt="fault-tolerance-example" caption="" %}
...
{% include image.html src="assets/images/system-design/fault-tolerance-recovery-example.png" alt="fault-tolerance-recovery-example" caption="" %}
...
{% include image.html src="assets/images/system-design/reconciliation-flow.png" alt="reconciliation-flow" caption="" %}
