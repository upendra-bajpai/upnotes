---
layout: post
title:  "Chapter11 - ios-push-notifications"
author: sal
date: 2025-01-21-00:10:20
categories: [tutorial, ios-push-notifications,system design]
image: assets/images/system-design/ios-push-notifications.png
---
...
{% include image.html src="assets/images/system-design/ios-push-notifications.png" alt="ios-push-notifications" caption="" %}
...
{% include image.html src="assets/images/system-design/android-push-notifications.png" alt="android-push-notifications" caption="" %}

### SMS Message
For SMS, third-party providers like Twilio are available:
{% include image.html src="assets/images/system-design/sms-messages.png" alt="sms-messages" caption="" %}

### Email
Although clients can setup their own mail servers, most clients opt-in to use third-party services, like Mailchimp:
{% include image.html src="assets/images/system-design/email-sending.png" alt="email-sending" caption="" %}

Here's final design after including all notification providers:
{% include image.html src="assets/images/system-design/notification-providers-design.png" alt="notification-providers-design" caption="" %}
...
{% include image.html src="assets/images/system-design/contact-info-gathering.png" alt="contact-info-gathering" caption="" %}

Example database tables for storing contact info:
{% include image.html src="assets/images/system-design/contact-info-db.png" alt="contact-info-db" caption="" %}
...
{% include image.html src="assets/images/system-design/high-level-design-improved.png" alt="high-level-design-improved" caption="" %}
...
{% include image.html src="assets/images/system-design/notification-log-db.png" alt="notification-log-db" caption="" %}
...
{% include image.html src="assets/images/system-design/notifications-queue.png" alt="notifications-queue" caption="" %}
...
{% include image.html src="assets/images/system-design/notification-events.png" alt="notification-events" caption="" %}
