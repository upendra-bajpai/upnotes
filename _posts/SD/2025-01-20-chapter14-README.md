...
![google-search](/assets/images/system-design/google-search.png)
...
![frequency-table](/assets/images/system-design/frequency-table.png)
...
![query-service-example](/assets/images/system-design/query-service-example.png)

Querying the data set is a matter of running the following SQL query:
![query-service-sql-query](/assets/images/system-design/query-service-sql-query.png)
...
![trie-example-with-frequency](/assets/images/system-design/trie-example-with-frequency.png)
...
![trie-algorithm](/assets/images/system-design/trie-algorithm.png)
...
![caching-top-search-results](/assets/images/system-design/caching-top-search-results.png)
...
![data-gathering-service](/assets/images/system-design/data-gathering-service.png)

The analytics logs contain raw rows of data related to search terms \w timestamps:
![analytics-log](/assets/images/system-design/analytics-log.png)
...
![weekly-aggredated-data](/assets/images/system-design/weekly-aggredated-data.png)
...
![trie-as-hashmap](/assets/images/system-design/trie-as-hashmap.png)

## Query service
The query service fetches top suggestions from Trie Cache or fallbacks to Trie DB on cache miss:
![query-service-improved](/assets/images/system-design/query-service-improved.png)
...
![google-browser-caching](/assets/images/system-design/google-browser-caching.png)
...
![update-trie](/assets/images/system-design/update-trie.png)
...
![filter-layer](/assets/images/system-design/filter-layer.png)
...
![sharding](/assets/images/system-design/sharding.png)
